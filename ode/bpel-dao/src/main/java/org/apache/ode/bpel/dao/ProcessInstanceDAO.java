 ...
 * object for data related to a particular process instance; this state includes
 * auditing events, scopes, pick/received waiters, and the serialized process
 * instance image.
 */
public interface ProcessInstanceDAO {
	...
	void setFault(QName faultName, String explanation, int faultLineNo,
	...
	// @hahnml
	/**
	 * Creates a new ProcessInstanceMigrationDAO for the given process instance.
	 * 
	 * @return The created ProcessInstanceMigrationDAO.
	 */
	public ProcessInstanceMigrationDAO createInstanceMigration();

	// @hahnml
	/**
	 * Provides the instance migration information of the process instance.
	 * 
	 * @return The ProcessInstanceMigrationDAO of the instance.
	 */
	public ProcessInstanceMigrationDAO getInstanceMigrationDAO();

	// @hahnml
	/**
	 * Delete the process instance migration object from the database.
	 */
	void deleteProcessInstanceMigration();
	...
	/**
	 * Returns all variable instances matching the variable name for a specified
	 * scope.
	 */
	 ...
	 * duties. The DAO's state indicates whether any fault has occured.
	 */
	 ...
	 * Delete the process instance object from the database.
	 * 
	 * @param cleanupCategories
	 *            the categories of entities to delete
	 * @param deleteMyRoleMex
	 *            will clean up the my role mex if set to true
	 */
	...
	/**
	 * Create an activity recovery object for a given activity instance. Specify
	 * the reason and optional data associated with the failure. Date/time
	 * failure occurred, and the recovery channel and available recovery
	 * actions.
	 */
	...
	// @hahnml
	/**
	 * Creates a new LinkDAO for the given process instance.
	 * 
	 * @return The created LinkDAO.
	 */
	public LinkDAO createLinkDAO(String xpath, int linkModelId);

	// @hahnml
	/**
	 * Provides the LinkDAO with the given model id of the process instance.
	 * 
	 * @return The LinkDAO with the given model id of the instance.
	 */
	public LinkDAO getLink(Integer linkModelId);
	
	/**
	 * Returns all the links belonging to this instance.
	 * 
	 * @return
	 */
	Collection<LinkDAO> getLinks();
}
