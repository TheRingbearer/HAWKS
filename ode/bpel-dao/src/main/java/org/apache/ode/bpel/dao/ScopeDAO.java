...
/**
 * Data access objec representing a BPEL scope instance. Objects of this class
 * manage a collection of correlation sets and XML data variables.
 */
public interface ScopeDAO {
	...
	/**
	 * Get scope name (from the definition / or auto-generated). NOTE: the scope
	 ...
	 * 
	 * @param plinkModelId
	 *            partner link model id
	 * @param pLinkName
	 *            partner link name
	 * @return {@link PartnerLinkDAO} object representing the created endpoint
	 *         reference
	 */
	 ...
	 * @param plinkModelId
	 *            partner link model id
	 * @return {@link PartnerLinkDAO} object representing the requested endpoint
	 *         reference
	 */
