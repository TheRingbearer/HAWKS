...
/**
 * <p>
 * Data access object representing a BPEL correlation set. Correlation sets are
 * late-bound constants that "belong" either to the process or to a scope.
 * </p>
 */
public interface CorrelationSetDAO {
	 ...
	 * 
	 * @param names
	 *            qualified names of the correlation set properties
	 * @param values
	 */
	...
	/**
	 * Resets the correlation set so it can be initialized again. Needed for iteration/re-execution.
	 * 
	 * @author sonntamo
	 */
	public void clear();
	...
	/**
	 * @return the process this correlation is related to, gives a chance of
	 *         optimization to the underlying impl
	 */
	ProcessDAO getProcess();

	/**
	 * @return the instance this correlation is related to, gives a chance of
	 *         optimization to the underlying impl
	 */
