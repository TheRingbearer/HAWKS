...
public interface BpelDAOConnection {
	 ...
	 */
	List<Date> bpelEventTimelineQuery(InstanceFilter ifilter,
	...
	Map<Long, Collection<CorrelationSetDAO>> getCorrelationSets(
	...
	// AH:
	/**
	 * Returns an interface for Fragment composition channel management.
	 * 
	 * @return a ProcessManagement DAO
	 */
	FCManagementDAO getFCManagement();
	// AH: end
}
