...
/**
 * Instances and associated data for a ProcessDAO implementation that implements
 * this interface can be deleted in a deferred fashion.
 * 
 * @author sean
 * 
 */
public interface DeferredProcessInstanceCleanable {
	 ...
	 * deletes is limited by the transaction size.
	 * 
