...
public interface MessageExchangeDAO {
	 ...
	 * myRole message exchanges, it is possible that no process is associated
	 * with the message exchange (i.e. if the EPR routing fails).
	 * 
	...
	/**
	 * Gets the mex id for the message exchange that has been piped with this
	 * one in a process to process interaction.
	 * 
	 * @return
	 */
