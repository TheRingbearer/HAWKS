 ...
 * instances ({@link ProcessInstanceDAO} and messages bound for instances yet to
 * be created or not yet correlated..
 */
public interface ProcessDAO {
	 ...
	 * @param cckey
	 *            correlation key
	 * @return collection of {@link ProcessInstanceDAO} that match correlation
	 *         key, ordered by date
	 */
	...
	/**
	 * Deletes only the process and routes without instances. This also deletes
	 * any static data to the process: correlators.
	 */
	...
	/**
	 * @return all instances that haven't completed, use with care as there
