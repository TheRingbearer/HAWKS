...
public class DeploymentUnitDaoImpl extends HibObj implements DeploymentUnitDAO {
	 ...
	 * @hibernate.collection-key column="DU" foreign-key="none"
	 ...
	 * 
	 * @hibernate.property column="DEPLOYDT"
	 */
	...
	public ProcessConfDAO getProcess(final QName pid) {
		return CollectionsX.find_if(_processes,
				new MemberOfFunction<ProcessConfDAO>() {
					@Override
