...
public interface CommandContext {
	...
	/**
	 * Send output to the equivalent of standard out. Note that this is not
	 * required to be pretty if it's not on a console, i.e., multiple
	 * invocations might not appear on a single line.
	 * 
	 * @param s
	 *            the content to send.
	 */
