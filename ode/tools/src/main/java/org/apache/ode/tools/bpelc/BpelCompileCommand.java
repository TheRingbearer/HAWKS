...
public class BpelCompileCommand implements Command {
	...
	private static final BpelCompileCommandMessages __msgs = MessageBundle
			.getMessages(BpelCompileCommandMessages.class);
		...
		for (String bpelURI : _bpelFiles) {
			...
			try {
				...
				throw new ExecutionException(
						__msgs.msgIoExReadingStreamWithMsg(bpelFile,
								ioe.getMessage()));
