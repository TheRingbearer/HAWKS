...
public class DOMUtilsTest extends TestCase {
	...
	public void testParseInputStream() throws Exception {
		Document doc = DOMUtils.parse(TestResources.getLoanApprovalProcess()
				.openStream());
	...
	public void testSerializeDom() throws Exception {
		...
		assertEquals(foo.toString(),
				DOMUtils.stringToDOM(DOMUtils.domToString(foo)).toString());
		assertEquals(bar.toString(),
				DOMUtils.stringToDOM(DOMUtils.domToString(bar)).toString());
