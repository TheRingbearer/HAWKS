...
public class CommandlineTest extends TestCase {
	...
	public void testUserOrder() {
		...
		Fragments g = new Fragments(new CommandlineFragment[] { last, first,
				second });
		...
		Fragments h = new Fragments(new CommandlineFragment[] { last, first,
				secondtolast, second });
	...
	private void doFlag(Flag f, List<List<String>> tests, boolean[] good,
			boolean[] set, List<List<String>> post) {
	...
	private void doFlagWithArgument(FlagWithArgument f,
			List<List<String>> tests, List<String> values, boolean[] good,
			boolean[] set, List<List<String>> post) {
		for (int i = 0; i < tests.size(); ++i) {
			List l = null;
			if (good[i]) {
			...
			if (set[i]) {
				...
				assertTrue(i + " didn't match the postcondition.",
						Collections.indexOfSubList(post.get(i), l) != -1);
				assertTrue(f.getValue() + "!= " + values.get(i), values.get(i)
						.equals(f.getValue()));
			} else {
				assertFalse(i + " should not have been set.", f.isSet());
			}
	...
	public void testOptionalArgument() {
		...
		List<List<String>> tests = Arrays.asList(Arrays.asList("foo"),
				Arrays.asList(EMPTY_STRING_ARRAY));

		String[] values = new String[] { "foo", null };

		boolean[] good = new boolean[] { true, true };

		boolean[] set = new boolean[] { true, false };

		List<List<String>> post = Arrays.asList(Arrays.asList(new String[] {}),
	...
	public void testRequiredArgument() {
		...
		boolean[] good = new boolean[] { true, false };

		boolean[] set = new boolean[] { true, false };

		List<List<String>> post = Arrays.asList(
				Arrays.asList(EMPTY_STRING_ARRAY), null);
	...
	public void testOptionalMultiArgument() {
		...
		List<List<String>> tests = Arrays.asList(Arrays.asList("foo"),
				Arrays.asList("foo", "bar"), Arrays.asList(EMPTY_STRING_ARRAY));

		List<List<String>> values = Arrays.asList(Arrays.asList("foo"),
				Arrays.asList("foo", "bar"), null);

		boolean[] good = new boolean[] { true, true, true };

		boolean[] set = new boolean[] { true, true, false };
	...
	public void testRequiredMultiArgument() {
		...
		boolean[] good = new boolean[] { true, true, false };
	...
	private void doArgument(Argument f, List<List<String>> tests,
			String[] values, boolean[] good, boolean[] set,
		...
		for (int i = 0; i < tests.size(); ++i) {
			...
			if (set[i]) {
				...
				assertTrue(f.getValue() + "!= " + values[i],
						values[i].equals(f.getValue()));
			} else {
				assertFalse(i + " should not have been set.", f.isSet());
			}
			f.reset();
	...
	private void doMultiArgument(MultiArgument f, List<List<String>> tests,
			List<List<String>> values, boolean[] good, boolean[] set,
			List<List<String>> post) {
		for (int i = 0; i < tests.size(); ++i) {
			List l = null;
			if (good[i]) {
	...
	public void testOptionalFlagWithArgument() {
		...
		List<List<String>> tests = Arrays.asList(
				...
				Arrays.asList("-x", "bar"), Arrays.asList(EMPTY_STRING_ARRAY),
				Arrays.asList("foo"), Arrays.asList("foo", "bar"),
				Arrays.asList("-x"), Arrays.asList("foo", "-x"));

		List<String> values = Arrays.asList("bar", "foo", "baz", "bar", null,
				null, null, null, null);

		boolean[] good = new boolean[] { true, true, true, true, true, true,
				true, false, false };

		boolean[] set = new boolean[] { true, true, true, true, false, false,
				false, false, false };

		List<List<String>> post = Arrays.asList(Arrays.asList("foo", "baz"),
				Arrays.asList("bar"), Arrays.asList("foo", "bar"),
				Arrays.asList(EMPTY_STRING_ARRAY),
				Arrays.asList(EMPTY_STRING_ARRAY), Arrays.asList("foo"),
				Arrays.asList("foo", "bar"), null, null);
	...
	public void testRequiredFlagWithArgument() {
		...
		boolean[] good = new boolean[] { true, true, true, true, false, false,
				false, false, false };

		boolean[] set = new boolean[] { true, true, true, true, false, false,
				false, false, false };

		List<List<String>> post = Arrays
				.asList(Arrays.asList("foo", "baz"), Arrays.asList("bar"),
						Arrays.asList("foo", "bar"),
						Arrays.asList(EMPTY_STRING_ARRAY), null, null, null,
						null, null);
	...
	public void testOptionalFlag() {
		...
		List<List<String>> tests = Arrays.asList(
				...
				Arrays.asList("-x", "foo", "bar"),
				Arrays.asList("foo", "bar", "-x"), Arrays.asList("-x"),
				Arrays.asList(EMPTY_STRING_ARRAY), Arrays.asList("foo"),
				Arrays.asList("foo", "bar"));
		...
		List<List<String>> post = Arrays.asList(Arrays.asList("foo", "bar"),
