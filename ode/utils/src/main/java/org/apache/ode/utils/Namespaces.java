...
public class Namespaces {
	...
	public static final String JBI_END_POINT_REFERENCE = "http://java.sun.com/jbi/end-point-reference"
			.intern();
	public static final QName WS_ADDRESSING_ENDPOINT = new QName(
			WS_ADDRESSING_NS, "EndpointReference");
	public static final QName WS_ADDRESSING_USINGADDRESSING = new QName(
			WS_ADDRESSING_WSDL_NS, "UsingAddressing");
	...
	public static final String ODE_PMAPI = "http://www.apache.org/ode/pmapi/types/2006/08/02/"
			.intern();
	public static final String ODE_PMAPI_TYPES_NS = "http://www.apache.org/ode/pmapi/types/2006/08/02/"
			.intern();
	public static final String ODE_PMAPI_NS = "http://www.apache.org/ode/pmapi"
			.intern();
	public static final String ODE_DEPLOYAPI_NS = "http://www.apache.org/ode/deployapi"
			.intern();
