...
public class LoggingXmlErrorHandler implements XMLErrorHandler {
	...
	private static final XsdMessages __msgs = MessageBundle
			.getMessages(XsdMessages.class);
	...
	public void warning(String domain, String key, XMLParseException ex)
			throws XNIException {
		_log.warn(__msgs.msgXsdMessage(__msgs.msgXsdWarning(), ex.getMessage(),
				ex.getLiteralSystemId(), ex.getColumnNumber(),
				ex.getLineNumber()), ex);
	}
	...
	public void error(String domain, String key, XMLParseException ex)
			throws XNIException {
		_log.error(
				__msgs.msgXsdMessage(__msgs.msgXsdError(), ex.getMessage(),
						ex.getLiteralSystemId(), ex.getColumnNumber(),
						ex.getLineNumber()), ex);
		_ex = ex;
		throw ex;
	...
	public void fatalError(String domain, String key, XMLParseException ex)
			throws XNIException {
		_log.error(
				__msgs.msgXsdMessage(__msgs.msgXsdFatal(), ex.getMessage(),
						ex.getLiteralSystemId(), ex.getColumnNumber(),
						ex.getLineNumber()), ex);
		_ex = ex;
		throw ex;
