...
/**
 * XML Dependency Scanner, processes XML and follows "import"s, "include"s, and
 * the like to discover the transitive closure of the dependencies. The scanner
 * supports WSDL, XMLSchema, and BPEL import elements, and can be extended by
 * implementing additional {@link Tracker} classes.
 */
public class XmlDependencyScanner {
	...
	/**
	 * Set the {@link EntityResolver} that should be used to obtain the byte
	 * streams for URIs.
	 * 
	 * @param resolver
	 *            {@link EntityResolver} or null for the default (URL) resolver
	 */
