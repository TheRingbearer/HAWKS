...
public class StreamUtils {
	 ...
	 *             in case of I/O error
	 */
	public static void copy(OutputStream dest, InputStream source, int bufSize)
			throws IOException {
	 ...
	 *             in case of I/O error
	 */
	public static void copy(Writer dest, Reader source, int bufSize)
			throws IOException {
	 ...
	 */
	public static void copy(OutputStream dest, InputStream source)
			throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void write(OutputStream dest, Serializable src)
			throws IOException {
	...
	public static Object readObj(InputStream is) throws IOException,
