...
public class RelativeDateParser {
	...
	/**
	 * This array of strings contains all supported "modifiers" for method
	 * <code>parseRelativeDate</code>. NOTE: An order of elements in this array
	 * is important and used in algorithm of above method!
	 */
	...
	/**
	 * Returns a date which is less than current system date/time on a specified
	 * number of days, years, minutes, weeks etc.
	 * <p/>
	 ...
	 * <p>
	 * <em>Modifiers are case sensitive</em>. Modifiers separated by single
	 * space character or sequence of spaces. Each modifier is optional, but an
	 * order of modifiers is matter and must be exactly the same how its
	 * specified in template.
	 * </p>
	 * <p/>
	 * Here is a few examples of date templates and its meanings:<br/>
	 * <code>"4h 3m 23s"</code> - means 4 hours, 3 minutes and 23 seconds ago
	 * from current system date<br/>
	 * <code>"1y 2m 3w"</code> - means 1 year, 2 months and 3 weeks ago from
	 * current system date<br/>
	 * <code>"1m 1w 13h 5m"</code> - means 1 month, 1 week, 13 hours and 5
	 * minutes ago from current system date<br/>
	 * 
	 * @param dateTemplate
	 *            a template of a date we want to be calculated
	 * @return a resulted <code>Date</code> object that is applies specified
	 *         template
	 * @throws java.text.ParseException
	 *             if some problems were occurred while parsing specified date
	 *             template
	 */
