 ...
 * {@link org.apache.ode.utils.xml.capture.XmlSchemaTracker} class because a
 * WSDL document may have in-line schemas.
 */
public class Wsdl11Tracker extends XmlSchemaTracker {
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (uri != null && NS.equals(uri) && EL_IMPORT.equals(localName)) {
			...
			__log.debug("found WSDL11 reference element " + uri + "@"
					+ localName + "-->" + schemaLoc);
