...
public class FileUtils {
	 ...
	 * applied to the given rootDirectory. As a result the rootDirectory might
	 * be in the returned list.
	 * <p>
	 * Returned files are ordered lexicographically but for each directory,
	 * files come before its sudirectories. For instance:<br/>
	 * test<br/>
	 * test/alpha.txt<br/>
	 * test/zulu.txt<br/>
	 * test/a<br/>
	...
	public static List<File> directoryEntriesInPath(File rootDirectory,
		...
		if (rootDirectory.isFile()) {
			if ((filter == null)
					|| ((filter != null) && (filter.accept(rootDirectory)))) {
	...
	private static void directoryEntriesInPath(List<File> collectedFiles,
			File parentDir, FileFilter filter) {
		if ((filter == null)
				|| ((filter != null) && (filter.accept(parentDir)))) {
