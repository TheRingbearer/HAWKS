...
public class XMLParserUtils {
	...
	private static final String EXTERNAL_SCHEMA_LOC_XERCESP = XERCES_P_ROOT
			+ "external-schemaLocation";
	private static final String EXTERNAL_SCHEMA_NNS_LOC_XERCESP = XERCES_P_ROOT
			+ "external-noNamespaceSchemaLocation";

	/**
	 * <p>
	 * Get the 'correct' implementation of a JAXP <code>SAXParserFactory</code>;
	 * this is intended to ensure that local implementations (e.g., Crimson)
	 * don't sneak into the mix.
	 * </p>
	 * 
	 ...
	 * <code>DocumentBuilderFactory</code>; this is intended to ensure that
	 * local implementations (e.g., Crimson) don't sneak into the mix.
	 * </p>
	 * 
	 ...
	 * 
	 * @param xr
	 *            the <code>XMLReader</code> to apply the feature to.
	 */
	...
	/**
	 * <p>
	 * Specify an external schema location and turn on validation via setting
	 * features and properties.
	 * </p>
	 * 
	 * @param xr
	 *            the XMLReader to apply the features and properties to.
	 * @param namespace
	 *            the namespace URI of the schema to validate, with the empty
	 *            string or <code>null</code> serving to represent the empty
	 *            namespace.
	 * @param u
	 *            the URL (or relative URL) that contains the schema.
	 * @throws SAXNotSupportedException
	 *             if one of the underlying feature/property settings does.
	 * @throws SAXNotRecognizedException
	 *             if one of the underlying feature/property settings does.
	 */
	public static void setExternalSchemaURL(XMLReader xr, String namespace,
			String u) throws SAXNotRecognizedException,
	 ...
	 * 
	 * @param dp
	 *            the <code>DOMParser</code> to apply the features and
	 *            properties to.
	 * @param namespace
	 *            the namespace URI of the schema to validate, with the empty
	 *            string or <code>null</code> serving to represent the empty
	 ...
	 *             if one of the underlying feature/property settings does.
	 */
	public static void setExternalSchemaURL(DOMParser dp, String namespace,
			String u) throws SAXNotRecognizedException,
			SAXNotSupportedException {
	...
	/**
	 * <p>
	 * Add a namespace/URL pair to the mapping between namespaces and the
	 * schemas used to validate elements in them. Adding a pair for a namespace
	 * that's already bound will result in overwriting the URL previously bound.
	 * </p>
	 * 
	 * @param xr
	 * @param namespace
	 ...
	 * @throws SAXNotSupportedException
	 */
	public static void addExternalSchemaURL(XMLReader xr, String namespace,
			String u) throws SAXNotRecognizedException,
			SAXNotSupportedException {
		xr.setFeature(VALIDATION_SAXF, true);
		xr.setFeature(SCHEMA_V_XERCESF, true);
		...
		while (st.hasMoreTokens()) {
			...
			if (!st.hasMoreTokens()) {
				throw new RuntimeException(
						"Property has been misconfigured; expected an "
	 ...
	 *             if one of the underlying feature/property settings does.
	 */
	public static void addExternalSchemaURL(DOMParser dp, String namespace,
			String u) throws SAXNotRecognizedException,
			SAXNotSupportedException {
		dp.setFeature(VALIDATION_SAXF, true);
		dp.setFeature(SCHEMA_V_XERCESF, true);
