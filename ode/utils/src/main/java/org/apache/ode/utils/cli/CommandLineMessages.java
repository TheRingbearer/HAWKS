...
public class CommandLineMessages extends MessageBundle {
	...
	public String msgCliHeader(String cmd, String version, String date) {
		return this.format(
				"{0} - Apache ODE v{1} ({2})" + SystemUtils.lineSeparator()
						+ "Copyright (c) 2006-2007 Apache ODE.", cmd, version,
				date);
	}
	...
	public String msgVeryVerbose() {
		return this
				.format("provide very verbose logging information to the console"
						+ " (on standard error)");
	}
	...
	public String msgQuiet() {
		return this
				.format("do not output the program name and version header to"
