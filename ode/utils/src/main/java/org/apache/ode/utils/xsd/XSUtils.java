...
public class XSUtils {
	 ...
	 * @return
	 */
	public static Map<URI, byte[]> captureSchema(URI systemURI,
			byte[] schemaData, XMLEntityResolver resolver) throws XsdException {
	...
	private static Map<URI, byte[]> captureSchema(LSInput input,
		...
		CapturingXMLEntityResolver cr = new CapturingXMLEntityResolver(
				captured, resolver);

		XMLSchemaLoader schemaLoader = new XMLSchemaLoader();
		schemaLoader.setEntityResolver(cr);
		schemaLoader.setFeature(
