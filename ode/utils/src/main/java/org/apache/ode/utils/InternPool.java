...
/**
 * A key value based cache that internalizes immutable values so that they can
 * be shared across various BPEL objects.
 * 
 */
public class InternPool {
	private static MultiKeyMap cachedValues = MultiKeyMap
			.decorate(new LRUMap());
	private static Set<String> cachedBlocks = Collections
	...
	/**
	 * Runs the given block in the context of a cache. If you do not run your
	 * block this way, the caching mechanism will be disabled.
	 * 
	 * @param block
	 *            block
	 */
	...
	/**
	 * An interface that clients should implement to run their blocks of code in
	 * the context of this caching mechanism.
	 */
