...
public class QNameUtils {
	...
	/**
	 * Create a string representation from a {@link QName}. The string will have
	 * the form <code>{URI}localpart</code>.
	 * 
	 * @param qname
	 *            a {@link QName}.
	 * 
	 ...
	 *             if the given string is not a valid stringified {@link QName}.
	 */
