...
public class XSTypes {
	...
	public static Object toJavaObject(QName type, String value) {
		...
		try {
			...
			throw new IllegalArgumentException(
					"The type "
							+ foundType
							+ " has been detected using the XSD type "
							+ type
							+ " but the parsing failed! The provided value is probably not of the right type:"
							+ nfe.toString());
		}
		throw new IllegalArgumentException("Couldn't find java type for "
				+ type);
	}
	...
	enum DECIMAL {
		DECIMAL, INTEGER, NONPOSITIVEINTEGER, LONG, NONNEGATIVEINTEGER, NEGATIVEINTEGER, INT, UNSIGNEDLONG, POSITIVEINTEGER, SHORT, BYTE, UNSIGNEDINT, UNSIGNEDSHORT, UNSIGNEDBYTE
	}
