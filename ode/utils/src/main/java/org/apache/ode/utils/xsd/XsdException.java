...
public class XsdException extends Exception {
	 ...
	 */
	public XsdException(XsdException previous, String message, int lineNumber,
			int columnNumber, String literalSystemId) {
		super(__msgs.msgXsdExceptionMessage(message, literalSystemId,
