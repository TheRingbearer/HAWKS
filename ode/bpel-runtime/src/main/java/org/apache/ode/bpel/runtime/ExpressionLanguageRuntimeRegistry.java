...
/**
 * A registry of {@link ExpressionLanguageRuntime} objects that is able to map a
 * given expression to the appropriate language runtime.
 */
public class ExpressionLanguageRuntimeRegistry {
	...
	public void registerRuntime(OExpressionLanguage oelang)
		...
		try {
			...
			ExpressionLanguageRuntime elangRT = (ExpressionLanguageRuntime) cls
					.newInstance();
	...
	public Calendar evaluateAsDate(OExpression cexp, EvaluationContext ctx)
			throws FaultException, EvaluationException {
