...
/**
 * Exception thrown by
 * {@link org.apache.ode.bpel.intercept.MessageExchangeInterceptor}
 * implementations that is used to indicate that the processing of the exchange
 * should be aborted with a failure.
 * 
