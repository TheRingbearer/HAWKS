...
public class ReplayerScheduler implements Scheduler {
		...
		while (!taskQueue.isEmpty()) {
			...
			try {
				...
				if (taskElement.runtimeContext != null) {
					taskElement.runtimeContext
							.setCurrentEventDateTime(taskElement.when);
				}
	...
	public String schedulePersistedJob(final JobDetails jobDetail,
			final Date when1) throws ContextException {
