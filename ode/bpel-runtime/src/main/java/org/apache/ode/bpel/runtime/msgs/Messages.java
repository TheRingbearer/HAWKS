...
public class Messages extends MessageBundle {
	...
	public String msgUnableToCompileXPath(String expr, int lineNo, String reason) {
		return this.format(
				"Unable to compile XPath expression {0} (line#{1}): {2}", expr,
				lineNo, reason);
	}
	 ...
	 * 
	 *            Non-static string values for location paths are not allowed;
	 *            the expression {0} at line {1} evaluates to type {2}.
	 */
	public String msgLocationMustBeString(String pathString, int lineNo,
			String type) {
		return this
				.format("Non-static string values for location paths are not allowed;"
						+ "the expression {0} at line {1} evaluates to type {2}.",
						pathString, lineNo, type);
	}

	// TODO better message
	public String msgPropertyAliasReturnedRValue(String alias, String variable) {
		return this.format("msgPropertyAliasReturnedRValue: {0} {1}", alias,
				variable);
	}

	// TODO better message
	public String msgPropertyAliasReturnedNonElement(String alias,
			String variable) {
		return this.format("msgPropertyAliasReturnedNonElement: {0} {1}",
				alias, variable);
	}
