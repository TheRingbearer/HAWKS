 ...
 * {@link org.apache.ode.bpel.pmapi.istate.InstanceDocument} objects.
 */
public class ActivityStateDocumentBuilder implements BpelEventListener {

	private HashMap<Long, ActivityInfoDocument> _activities = new HashMap<Long, ActivityInfoDocument>();

	/**
	 * Keep a list of the activity info objects, so we can return them in the
	 * order of creation.
	 */
	private ArrayList<ActivityInfoDocument> _activitiesOrdered = new ArrayList<ActivityInfoDocument>();
