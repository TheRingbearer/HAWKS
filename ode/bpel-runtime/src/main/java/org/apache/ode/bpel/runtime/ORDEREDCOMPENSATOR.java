...
public class ORDEREDCOMPENSATOR extends BpelJacobRunnable {
	...
	public String toString() {
		return new StringBuffer("ORDEREDCOMPENSATOR(comps=")
				.append(_compensations).append(")").toString();
	}
