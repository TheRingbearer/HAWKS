...
public class InstanceFilter implements Serializable {
	...
	private int _skip = 0;
	private Map<String, CorrelationKey> _correlations = new HashMap<String, CorrelationKey>();
	 ...
	 * @param correlation
	 */
	public void addCorrelationSetFilter(String correlationSetName,
