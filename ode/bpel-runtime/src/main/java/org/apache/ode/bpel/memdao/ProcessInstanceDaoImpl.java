...
public class ProcessInstanceDaoImpl extends DaoBaseImpl implements
		ProcessInstanceDAO {
	private static final Collection<ScopeDAO> EMPTY_SCOPE_DAOS = Collections
			.emptyList();
	...
	//@hahnml
	private Map<Integer, LinkDAO> _links = new HashMap<Integer, LinkDAO>();

	// @hahnml: Holds the instance migration information
	private ProcessInstanceMigrationDaoImpl _instanceMigration = null;
	...
	public byte[] getExecutionState() {
		throw new IllegalStateException(
				"In-memory instances are never serialized");
	}
	...
	public ScopeDAO createScope(ScopeDAO parentScope, String scopeType,
			int scopeModelId) {
	...
	public ProcessInstanceMigrationDAO createInstanceMigration() {
		this._instanceMigration = new ProcessInstanceMigrationDaoImpl(this);

		return this._instanceMigration;
	}
	...
	public void deleteProcessInstanceMigration() {
		this._instanceMigration = null;
	}

	// @hahnml
	public LinkDAO createLinkDAO(String xpath, int linkModelId) {
		LinkDaoImpl newLink = new LinkDaoImpl(this, xpath, linkModelId);
		newLink.setState(LinkStateEnum.NOT_EVALUATED);
		_links.put(linkModelId, newLink);
