...
public class PartnerLinkInstance implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		return partnerLink.equals(other.partnerLink)
				&& scopeInstanceId.equals(other.scopeInstanceId);
	}
	...
	public String toString() {
		return ObjectPrinter.toString(this, new Object[] { "partnerLinkDecl",
				partnerLink, "scopeInstanceId", scopeInstanceId });
	}
}
