...
/**
 * An in-memory map from the endpoints provided by various processes in the
 * server to their corresponding endpoint references.
 * 
 * @author $author$
 * @version $Revision$
 */
public class SharedEndpoints {
	...
	/**
	 * Remove an endpoint along with its EPR This is called when there are no
	 * more references to this endpoint from any BPEL process (which provides a
	 * service at this endpoint)
	 * 
	 * @param endpoint
	 *            endpoint
	 */
	...
	/**
	 * Increment the number of BPEL processes who provide a service specifically
	 * at this endpoint.
	 * 
	 * @param endpoint
	 *            endpoint
	...
	/**
	 * Decrement the number of BPEL processes who provide a service specifically
	 * at this endpoint.
	 * 
	 * @param endpoint
	 *            endpoint
