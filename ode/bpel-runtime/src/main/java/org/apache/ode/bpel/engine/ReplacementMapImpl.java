...
/**
 * A JACOB {@link ReplacementMap} implementation that eliminates unnecessary
 * serialization of the (constant) compiled process model.
 */
public class ReplacementMapImpl implements ReplacementMap {
	...
	public Object getOriginal(Object replacement)
