 ...
 * {@link org.apache.ode.bpel.explang.ExpressionLanguageRuntime} interface for
 * constant expressions.
 */
public class KonstExpressionLanguageRuntimeImpl implements
	...
	public String evaluateAsString(OExpression cexp, EvaluationContext ctx)
		...
		throw new TypeCastException(TypeCastException.TYPE_STRING, konst
				.getVal().toString());
	}
	...
	public boolean evaluateAsBoolean(OExpression cexp, EvaluationContext ctx)
		...
		throw new TypeCastException(TypeCastException.TYPE_BOOLEAN, konst
				.getVal().toString());
	}
	...
	public Number evaluateAsNumber(OExpression cexp, EvaluationContext ctx)
		...
		throw new TypeCastException(TypeCastException.TYPE_NUMBER, konst
				.getVal().toString());
	}
	...
	public List evaluate(OExpression cexp, EvaluationContext ctx)
		...
		throw new TypeCastException(TypeCastException.TYPE_NODELIST, konst
				.getVal().toString());
	}

	public Node evaluateNode(OExpression cexp, EvaluationContext context)
			throws FaultException, EvaluationException {
		OConstantExpression konst = (OConstantExpression) cexp;
		if (konst.getVal() instanceof Node)
			return (Node) konst.getVal();
		throw new TypeCastException(TypeCastException.TYPE_NODE, konst.getVal()
				.toString());
	}
	...
	public Calendar evaluateAsDate(OExpression cexp, EvaluationContext context)
		...
		throw new TypeCastException(TypeCastException.TYPE_DATE, konst.getVal()
				.toString());
	...
	public Duration evaluateAsDuration(OExpression cexp,
		...
		throw new TypeCastException(TypeCastException.TYPE_DURATION, konst
				.getVal().toString());
	}
}
