...
public class ProcessInstance implements Serializable {
	 ...
	 * @param rootScopeId
	 *            unique ID for the root scope of this process instance
	 * @param createTime
	 *            create time of this process instance
	 * @param state
	 *            state of this process instance
	 */
	public ProcessInstance(String instanceId, String rootScopeId,
			long createTime, short state) {
	 ...
	 * 
	 * @param name
	 *            name of the global correlation set.
	 * 
	...
	public String[] getProcessCorrelations() {
		return _correlationKeys.keySet().toArray(
				new String[_correlationKeys.size()]);
	}
	...
	public void addCorrelationSet(String setName, Properties values) {
		_correlationKeys.put(setName, (values == null) ? new Properties()
				: values);
	}
