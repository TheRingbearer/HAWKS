...
public interface ProcessMonitor {
	...
	/**
	 * Inspect data variable. If variable has not been initialized, a null value
	 * will be returned.
	 * 
	 * @param scopeId
	 *            scope instance id of the variable
	 * @param variableName
	 *            variable name
	 * 
	 ...
	 * @throws MonitorException
	 */
	public String getVariableData(String processInstance, String scopeId,
			String variableName) throws MonitorException;

	/**
	 * Terminates the process instance
	 */
	public void kill(String processInstanceId) throws MonitorException;

	/**
	 * Pauses the process instance
	 */
	public void pause(String processInstanceId) throws MonitorException;

	/**
	 * Resumes the process instance (from paused state)
	 */
	public void resume(String processInstanceId) throws MonitorException;
}
