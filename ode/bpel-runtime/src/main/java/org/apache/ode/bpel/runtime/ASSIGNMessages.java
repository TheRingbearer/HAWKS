...
public class ASSIGNMessages extends MessageBundle {
	...
	public String msgRValueMultipleNodesSelected(String rvalue) {
		return this.format(
				"R-Value expression \"{0}\" returned multiple nodes.", rvalue);
	}

	/** R-Value expression "{0}" did not select any nodes. */
	public String msgRValueNoNodesSelected(String rvalue) {
		return this.format(
				"R-Value expression \"{0}\" did not select any nodes.", rvalue);
	}
	...
	public String msgLiteralMustContainTIIorEII() {
		return this
				.format("A literal must contain either a text information item (TII)"
	...
	public String msgInternalError(String msg) {
		return this
				.format("InternalError: Unexpected selection failure (contact tech support): {0}",
						msg);
	}
	...
	public String msgEvalException(String expr, String msg) {
		return this
				.format("An exception occured while evaluating \"{0}\": {1}",
						expr, msg);
	}
	...
	public String msgInvalidRValue() {
		return this
				.format("The R-Value must be a text information item (TII) or"
						+ " element information item (EII)");
	}

	/**
	 * The L-Value must be a text information item (TII), element information
	 * item (EII), or attribute information item (AII).
	 */
	public String msgInvalidLValue() {
		return this
				.format("The L-Value must be a text information item (TII),"
