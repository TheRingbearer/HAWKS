...
class MexDaoUtil {
	...
	static void setFailed(MessageExchangeImpl mex, FailureType ftype,
			String explanation) {
	...
	static void setFaulted(MessageExchangeImpl mex, QName faultType,
			Element faultmsg) {
	...
	static void setResponse(MessageExchangeImpl mex, QName responseType,
			Element response) {
	...
	public static void setFailure(PartnerRoleMessageExchangeImpl mex,
			FailureType type, String description, Element details) {
