...
/**
 * A very simple, in-memory implementation of the {@link CorrelationSetDAO}
 * interface.
 */
class CorrelationSetDaoImpl extends DaoBaseImpl implements CorrelationSetDAO {
	 ...
	 * @param scope
	 *            the scope for which the correlation set is relevant
	 */
	public CorrelationSetDaoImpl(String name,
			org.apache.ode.bpel.dao.ScopeDAO scope) {
		_name = name;
		_scope = scope;
