...
public interface WrappedFaultException {
	...
	/**
	 * Jaxenized {@link FaultException}; Jaxen requires us to throw only
	 * exceptions extending its {@link UnresolvableVariableException} so we
	 * comply.
	 */
	...
	/**
	 * Jaxenized {@link FaultException}; Jaxen requires us to throw only
	 * exceptions extending its {@link FunctionCallException} so we comply.
	 */
	static class JaxenFunctionException extends FunctionCallException implements
