...
public class XPath20ExpressionRuntimeTest extends TestCase implements
		EvaluationContext {
	...
	public void setUp() throws Exception {
		...
		_vardoc = DOMUtils.parse(getClass().getResourceAsStream(
				"/xpath20/variables.xml"));
	...
	public void testVariableSelectionEmpty() throws Exception {
		...
		assertTrue(DOMUtils.getFirstChildElement((Element) retVal)
				.getLocalName().equals("empty"));
	}
