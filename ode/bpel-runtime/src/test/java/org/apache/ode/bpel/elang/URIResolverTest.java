...
public class URIResolverTest {
	...
	public void testEncoding() throws Exception {
		Document original = DOMUtils.parse(getClass().getResourceAsStream(
				"/xslt/test.xml"));
		OXPath10Expression expr = new OXPath10Expression(null, null, null, null);
		...
		assertArrayEquals(original.getDocumentElement().getTextContent().trim()
				.getBytes(), doc.getDocumentElement().getTextContent().trim()
				.getBytes());
	}
	...
	public void testResolveURL() throws Exception {
		...
		Source source = resolver
				.resolve(
						"https://svn.apache.org/repos/asf/ode/trunk/bpel-schemas/src/main/xsd/pmapi.xsd",
						null);
		Document doc = DOMUtils.sourceToDOM(source);
