...
public class CoreBpelTest extends TestCase implements BpelRuntimeContext {
	...
	public Node fetchVariableData(VariableInstance var, boolean forWriting)
			throws FaultException {
		return null;
	}

	public Node fetchVariableData(VariableInstance var,
			OMessageVarType.Part partname, boolean forWriting)
			throws FaultException {
		return null;
	}
	...
	public void select(PickResponseChannel response, Date timeout,
	...
	public void registerActivityForRecovery(ActivityRecoveryChannel channel,
			long activityId, String reason, Date dateTime, Element data,
	...
	public void recoverActivity(String channel, long activityId, String action,
			FaultData fault) {
	}
	...
	public void initializeExternalVariable(VariableInstance instance,
	...
	public void updateIMAManagerData() {
		// TODO Auto-generated method stub
