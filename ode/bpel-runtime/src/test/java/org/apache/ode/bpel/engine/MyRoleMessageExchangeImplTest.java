...
public class MyRoleMessageExchangeImplTest extends MockObjectTestCase {
	...
	public void testResponseReceived() throws Exception {
		mexDao.expects(exactly(3)).method("getCorrelationId")
				.will(returnValue("corrId"));
	...
	public void testResponseTimeout() throws Exception {
		mexDao.expects(atLeastOnce()).method("getCorrelationId")
				.will(returnValue("corrId"));
		myRoleMexImpl.callbacks().put("corrId",
				new MyRoleMessageExchangeImpl.ResponseCallback());
	...
	protected void setUp() throws Exception {
		...
		SimpleScheduler scheduler = new SimpleScheduler("node", null,
				new Properties());
