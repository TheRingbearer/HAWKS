...
/**
 * This hibernate entity enables using the BPEL_MEX_PROPS table in HQL. This
 * entity is excluded from schema export.
 * 
 * @hibernate.class table="BPEL_MEX_PROPS" lazy="true"
 * @hibernate.query name="SELECT_MEX_PROPS_IDS_BY_INSTANCES" query=
...
public class HMessageExchangeProperty implements Serializable {
	...
	/**
	 * @hibernate.property column="NAME" type="string" length="8000"
	...
	/**
	 * @hibernate.property column="VALUE" type="string" insert="false"
	 *                     update="false"
	 */
