 ...
 * @hibernate.query name="SELECT_INSTANCES_BY_PROCESS"
 *                  query="from HProcessInstance as i where i.process = :process)"
 * @hibernate.query name="SELECT_INSTANCES_BY_PROCESS_AND_STATES" query=
 *                  "from HProcessInstance as i where i.process = :process and i.state in (:states)"
 * @hibernate.query name="COUNT_INSTANCES_BY_PROCESSES_IDS_AND_STATES" query=
...
public class HProcessInstance extends HObject {
	...
	/** Scope instances belonging to this process instance. */
	private Collection<HScope> _scopes = new HashSet<HScope>();
	
	//@hahnml
	/** Link instances belonging to this process instance. */
	private Collection<HLink> _links = new HashSet<HLink>();
	...
	/**
	 * 
	 * @hibernate.many-to-one column="PROCESS_ID" lazy="true" outer-join="true"
	 *                        not-found="ignore" foreign-key="none"
	 */
	 ...
	 * @hibernate.collection-key column="PIID" foreign-key="none"
	 * @hibernate.collection-one-to-many 
	 *                                   class="org.apache.ode.daohib.bpel.hobj.HLink"
	 */
	public Collection<HLink> getLinks() {
		return _links;
	}

	public void setLinks(Collection<HLink> links) {
		_links = links;
	}
	...
	public void setActivityRecoveries(
			Collection<HActivityRecovery> activityRecoveries) {
	...
	/**
	 * @hibernate.one-to-one column="MIGRATION" foreign-key="none"
	 */
	public HProcessInstanceMigration getMigration() {
		return _migration;
	}

	public void setMigration(HProcessInstanceMigration migration) {
