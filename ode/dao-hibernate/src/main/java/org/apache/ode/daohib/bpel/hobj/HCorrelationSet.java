 ...
 * @hibernate.query name="SELECT_CORSET_IDS_BY_INSTANCES" query=
 *                  "select id from HCorrelationSet as c where c.instance in (:instances)"
 * @hibernate.query name="SELECT_CORSETS_BY_INSTANCES" query=
 *                  "from HCorrelationSet as c left join fetch c.properties where c.instance.id in (:instances)"
 * @hibernate.query name="SELECT_CORSETS_BY_PROCESS_STATES" query=
