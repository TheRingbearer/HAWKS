...
public class HCorrelatorSelector extends HObject {
	...
	public String toString() {
		return "{HCorrelatorSelector correlator=" + this.getCorrelator()
				+ ", ckey=" + getCorrelationKey() + ", groupId=" + getGroupId()
				+ ", idx=" + getIndex() + ", iid=" + getInstance().getId()
				+ "}";
	}

	/**
	 * @hibernate.property column="CORRELATION_KEY" not-null="true"
	 * @hibernate.column name="CORRELATION_KEY" index="IDX_SELECTOR_CKEY"
	 *                   not-null="true" unique-key="UNIQ_SELECTOR"
	 * 
	 */
	...
	/**
	 * @hibernate.property column="CORRELATOR" not-null="true" insert="false"
	 *                     update="false"
	 */
