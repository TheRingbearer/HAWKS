...
public class HProcess extends HObject {
	 ...
	 * @hibernate.collection-key column="PROCESS_ID" foreign-key="none"
	 * @hibernate.collection-one-to-many 
	...
	/**
	 * @hibernate.bag lazy="true" inverse="true"
	 * @hibernate.collection-key column="PID" foreign-key="none"
	 * @hibernate.collection-one-to-many 
	 ...
	 * 
	 * @hibernate.property
	 * @hibernate.column name="PROCID" not-null="true" unique="true"
	 */
	 ...
	 * 
	 * @hibernate.property column="deployer"
	 */
	 ...
	 * 
	 * @hibernate.property column="deploydate"
	 */
	 ...
	 * 
	 * @hibernate.property column="type_name"
	 */
	 ...
	 * The type of the process (BPEL process definition name).
	 * 
	 * @hibernate.property column="type_ns"
	 */
	 ...
	 * The process status.
	 * 
	 * @hibernate.property column="ACTIVE_"
	 */
