 ...
 * @hibernate.query name="SELECT_XMLDATA_IDS_BY_INSTANCES"
 *                  query="select id from HXmlData as x where x.instance in (:instances)"
 */
public class HXmlData extends HObject {
	...
	/**
	 * @hibernate.property column="SIMPLE_VALUE" type="string" length="255"
	 *                     not-null="false"
	 */
