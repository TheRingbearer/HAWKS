 ...
 * @hibernate.query name="SELECT_CORMESSAGE_IDS_BY_INSTANCES" query=
 ...
 * @hibernate.query name="SELECT_CORMESSAGE_IDS_BY_MEX" query=
...
public class HCorrelatorMessage extends HObject {
	...
	public String toString() {
		return "{HCorrelatorMessage correlator=" + this.getCorrelator()
				+ ", ckey=" + getCorrelationKey() + ", mex="
				+ _messageExchange.getId() + "}";
	}

	/**
	 * @hibernate.property column="CORRELATION_KEY"
	 * @hibernate.column name="CORRELATION_KEY" index="IDX_UNMATCHED_CKEY"
	 * 
	 */
