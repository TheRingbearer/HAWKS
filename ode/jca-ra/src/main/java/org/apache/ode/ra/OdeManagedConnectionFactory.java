...
public class OdeManagedConnectionFactory implements ManagedConnectionFactory {
	...
	private OdeConnectionRequestInfo _defaultCRI = new OdeConnectionRequestInfo(
			null, "");
	...
	public void setTransport(String transportClassName)
		...
		try {
			...
			ResourceException re = new ResourceException(
					"Class-access error for transport class \""
							+ transportClassName + "\". ", e);
			throw re;
		} catch (InstantiationException e) {
			ResourceException re = new ResourceException(
					"Error instantiating transport class \""
							+ transportClassName + "\". ", e);
			throw re;
		} catch (ClassNotFoundException e) {
			ResourceException re = new ResourceException("Transport class \""
					+ transportClassName + "\" not found in class path. ", e);
			throw re;
	...
	public ManagedConnection createManagedConnection(Subject subject,
			...
			throws ResourceException {
		OdeConnectionRequestInfo cri = (OdeConnectionRequestInfo) (connectionRequestInfo != null ? connectionRequestInfo
				: _defaultCRI);
		...
		try {
			return new OdeManagedConnectionImpl(cri.transport.createPipe(
					cri.url, cri.properties), subject, connectionRequestInfo);
		} catch (RemoteException ex) {
			ResourceException re = new ResourceException(
					"Unable to create connection: " + ex.getMessage(), ex);
			throw re;
		}
	}

	public ManagedConnection matchManagedConnections(Set candidates,
