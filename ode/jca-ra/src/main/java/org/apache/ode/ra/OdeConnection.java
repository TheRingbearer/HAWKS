...
public interface OdeConnection extends Connection {
	 ...
	 * @return possibly remote proxy to the Service Provider's client session
	 *         interface.
	 */
	public ServiceProviderSession createServiceProviderSession(
			String serviceProviderUri, Class sessionInterface)
