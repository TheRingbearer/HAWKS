...
/**
 * Overloading the XPathFunctionLibrary to force it to initialize our functions
 * giving the provided parameters. Otherwise the Saxon implemetation just never
 * gives you any parameter before runtime.
 * 
...
public class OdeXPathFunctionLibrary extends
	...
	public Expression bind(int nameCode, String uri, String local,
		...
		XPathFunction function = _funcResolver.resolveFunction(name,
				staticArgs.length);
		if (function == null) {
			return null;
		}
