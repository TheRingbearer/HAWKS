 ...
 */
public class WSDLFactoryBPEL20 extends WSDLFactoryImpl implements
		WSDLFactory4BPEL {
	...
	public WSDLFactoryBPEL20() {
		super(Bpel20QNames.NS_WSBPEL2_0_FINAL_EXEC,
				Bpel20QNames.NS_WSBPEL2_0_FINAL_PLINK,
	...
	public ExtensionRegistry newPopulatedExtensionRegistry() {
		...
		extRegistry.registerDeserializer(Definition.class, new QName(_propNS,
				"property"), _bs);
		extRegistry.registerDeserializer(Definition.class, new QName(_propNS,
				"propertyAlias"), _bs);
		extRegistry.registerDeserializer(Types.class, XMLSchemaType.QNAME,
				new XMLSchemaTypeSerializer());
		extRegistry.registerDeserializer(Definition.class, new QName(_plnkNS,
				"partnerLinkType"), _bs);
		return extRegistry;
