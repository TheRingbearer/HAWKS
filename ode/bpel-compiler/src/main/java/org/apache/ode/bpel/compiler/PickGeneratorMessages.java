...
public class PickGeneratorMessages extends CompilationMessageBundle {
	 ...
	 * "{0}".
	 */
	public CompilationMessage errSecondNonInitiateOrJoinCorrelationSet(
			String setName) {
		return this.formatCompilationMessage(
				"Attempt to use multiple non-initiate or join correlation sets;"
	...
	public CompilationMessage errEmptyOnMessage() {
		return this
				.formatCompilationMessage("An onMessage element declared in a pick can't be empty.");
	}
	...
	public CompilationMessage errRendezvousNotSupported() {
		return this
				.formatCompilationMessage("Rendezvous correlation mode not supported in this context.");
	}
