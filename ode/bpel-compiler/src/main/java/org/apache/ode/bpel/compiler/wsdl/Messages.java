...
public class Messages extends MessageBundle {
	...
	public String msgMalformedQName(String str) {
		return this.format(
				"The string \"{0}\" is not a properly formatted QName.", str);
	}
	...
	public String msgMissingRoleForPartnerLinkType(String name) {
		return this.format(
				"The formatted error message The partnerLinkType {0} does"
	 ...
	 * @return the formatted error message
	 * 
	 *         The schema for {0} prohibits child elements or non-whitespace
	 ...
	 * @return the formatted message
	 * 
	 *         The referenced portType {1} for role {0} is not defined in this
	 *         definition or an import.
	 */
	public String msgNoSuchPortTypeForRole(String roleName, String portType) {
		return this.format(
				"The referenced portType {1} for role {0} is not defined in"
	...
	public String msgNoSuchMessageTypeForPropertyAlias(String messageType) {
		return this
				.format("A propertyAlias refers to the non-existent WSDL message type {0}.",
						messageType);
	}

	/**
	 * Format an error message about an element not being permissable as the
	 * root element in a WSDL document.
	 * 
	 * @param qname
	 *            the stringified <code>QName</code> of the element
	 * @return the formatted message
	 * 
	 *         The element {0} is not permitted as the root element in a WSDL
	 *         definition.
	 */
	public String msgCannotBeDocumentRootElement(String qname) {
		return this.format(
				"The element {0} is not permitted as the root element"
						+ " in a WSDL definition.", qname);
	}

	/**
	 * Format an error message about a WSDL extensibility element requiring to
	 * be a first level child of the definition element.
	 * 
	 * @param qname
	 *            the stringified <code>QName</code> of the element
	 * @return the formatted message.
	...
	public String msgMustBeChildOfDef(String qname) {
		return this
				.format("The element {0} must be a child of the WSDL definitions element.",
						qname);
	}
	 ...
	 * @return the formatted message
	 * 
	 *         A propertyAlias refers to the non-existent part {1} on the WSDL
	 *         message type {0}.
	 */
	public String msgNoSuchPartForPropertyAlias(String message, String part) {
		return this
				.format("A propertyAlias refers to the non-existent part {1} on the"
						+ " WSDL message type {0}.");
	}
	 ...
	 */
	public String msgAlreadyDefinedIn(String thing, String name, String origin,
			String redef) {
		return this.format(
				"The {0} {1} defined in {3} was already defined in {2}.",
	 ...
	 * @return the formatted message
	 * 
	 *         A property alias in {1} refers to the property {0}, which is not
	 *         defined.
	 */
	public String msgNoSuchProperty(String name, String documentBaseURI) {
		return this.format(
				"A property alias in {1} refers to the property {0},"
