...
public class IfActivity extends Activity {
	...
	/**
	 * Get the activity for this if. BPEL 2.0 draft mandated the inclusion of
	 * the condition success activity in a <then> element. In that case this
	 * will be null. For BPEL 2.0 final this should return the condition success
	 * activity.
	 * 
