 ...
 * <ol>
 * <li>
 * <code>namespace<code> - specifies the URI namespace of the imported definitions
 * </li>
 * <li><code>location</code> - contains a URI indicating the location of a
 * document that contains relevant definitions in the namespace specified</li>
 * <li><code>importType</code> - identifies the type of document being imported
 * by providing the URI of the encoding language. The value MUST be set to
 * "http://www.w3.org/2001/XMLSchema" when importing an XML Schema 1.0
 * documents, and to "http://schemas.xmlsoap.org/wsdl/" when importing WSDL 1.1
 * documents.</li>
 */
	...
	public URI getLocation() {
		...
		try {
			...
			throw new IllegalStateException(
					"Invalid BPEL document; import contains malformed location URI.",
					e);
		}
	}
