...
/**
 * An exception thrown when a BPEL <code>&lt;partnerLinkType&gt;</code>
 * declaration is invalid (from a schema perspective).
 */
public class InvalidBpelPartnerLinkTypeException extends WSDLException {
	 ...
	 *            an explanatory message
	 * @param t
	 *            the <code>Throwable</code> that triggered this exception.
	 * @see WSDLException#WSDLException(java.lang.String, java.lang.String,
	 *      java.lang.Throwable)
	 */
	public InvalidBpelPartnerLinkTypeException(String msg, Throwable t) {
