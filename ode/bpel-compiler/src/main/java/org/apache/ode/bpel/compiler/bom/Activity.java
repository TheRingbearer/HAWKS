...
public class Activity extends JoinFailureSuppressor {
	...
	public Expression getJoinCondition() {
		if (is11()) {
			return isAttributeSet("joinCondition") ? new Expression11(
					getElement(), getElement()
							.getAttributeNode("joinCondition")) : null;
		}

		Targets targets = getFirstChild(Targets.class);
		return targets == null ? null : (Expression) targets
				.getFirstChild(Expression.class);
	}
