...
import org.apache.ode.bpel.compiler.bom.FragmentExitActivity;
import org.apache.ode.bpel.compiler.bom.FragmentFlowActivity;
import org.apache.ode.bpel.compiler.bom.FragmentRegionActivity;
import org.apache.ode.bpel.compiler.bom.FragmentSequenceActivity;
...
public class BpelCompiler20 extends BpelCompiler {
	...
	public BpelCompiler20() throws Exception {
		...
		// AH:
		// registerActivityCompiler(FragmentScope.class, new
		// FragmentScopeGenerator());
		registerActivityCompiler(FragmentExitActivity.class,
				new FragmentExitGenerator());
		registerActivityCompiler(FragmentEntryActivity.class,
				new FragmentEntryGenerator());
		registerActivityCompiler(FragmentFlowActivity.class,
				new FragmentFlowGenerator());
		registerActivityCompiler(FragmentSequenceActivity.class,
				new FragmentSequenceGenerator());
		registerActivityCompiler(FragmentRegionActivity.class,
				new FragmentRegionGenerator());
		// AH: end

		registerActivityCompiler(EmptyActivity.class, new EmptyGenerator());
		registerActivityCompiler(CompensateScopeActivity.class,
				new CompensateScopeGenerator());
		registerActivityCompiler(CompensateActivity.class,
				new CompensateGenerator());
		registerActivityCompiler(FlowActivity.class, new FlowGenerator());
		registerActivityCompiler(SequenceActivity.class,
		...
		registerActivityCompiler(RepeatUntilActivity.class,
				new RepeatUntilGenerator());
		...
		registerActivityCompiler(TerminateActivity.class,
		...
		registerActivityCompiler(ExtensionActivity.class,
				new ExtensionActivtityGenerator());

		registerExpressionLanguage(OASIS_EXPLANG_XPATH_1_0,
				new XPath10ExpressionCompilerBPEL20());
