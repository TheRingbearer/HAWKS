...
public class Scope extends JoinFailureSuppressor {
	...
	public CorrelationSet getCorrelationSetDecl(final String setName) {
		return CollectionsX.find_if(getCorrelationSetDecls(),
				new MemberOfFunction<CorrelationSet>() {
	...
	public Variable getVariableDecl(final String varName) {
		return CollectionsX.find_if(getVariables(),
				new MemberOfFunction<Variable>() {
	...
	public PartnerLink getPartnerLink(final String partnerLinkName) {
		return CollectionsX.find_if(getPartnerLinks(),
				new MemberOfFunction<PartnerLink>() {
