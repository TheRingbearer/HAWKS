...
public abstract class Bpel20QNames {
	...
	// AH:
	/** Some Fragment Elements **/
	public static final String NS_WSBPEL2_0_FRAGMENT = "http://www.iaas.uni-stuttgart.de/ext/fragment";
	public static final QName FRAGMENT_SCOPE = newFinalFragmentQName("fragmentScope");
	public static final QName FRAGMENT_EXIT = newFinalFragmentQName("fragmentExit");
	public static final QName FRAGMENT_ENTRY = newFinalFragmentQName("fragmentEntry");
	public static final QName FRAGMENT_FLOW = newFinalFragmentQName("fragmentFlow");
	public static final QName FRAGMENT_SEQUENCE = newFinalFragmentQName("fragmentSequence");
	public static final QName FRAGMENT_REGION = newFinalFragmentQName("fragmentRegion");
	public static final QName ELEMENTS_TO_MAP = newFinalFragmentQName("elementsToMap");
	public static final QName VARIABLE_TO_MAP = newFinalFragmentQName("variableToMap");
	public static final QName PARTNER_LINK_TO_MAP = newFinalFragmentQName("partnerLinkToMap");
	public static final QName CORRELATION_SET_TO_MAP = newFinalFragmentQName("correlationSetToMap");
	// AH: end
	...
	public static final QName FINAL_SERVICE_REF = new QName(
			NS_WSBPEL2_0_FINAL_PLINK, "service-ref");
	...
	public static final QName FINAL_PROPALIAS = new QName(
			NS_WSBPEL2_0_FINAL_VARPROP, "propertyAlias");
	public static final QName FINAL_PROPERTY = new QName(
			NS_WSBPEL2_0_FINAL_VARPROP, "property");
	public static final QName FINAL_PROPQUERY = new QName(
			NS_WSBPEL2_0_FINAL_VARPROP, "query");
	public static final QName FINAL_PLINKTYPE = new QName(
			NS_WSBPEL2_0_FINAL_PLINK, "partnerLinkType");
	public static final QName FINAL_PLINKROLE = new QName(
			NS_WSBPEL2_0_FINAL_PLINK, "role");
	...
	public static final QName PLINKTYPE = new QName(
			NS_WSBPEL_PARTNERLINK_2004_03, "partnerLinkType");
	public static final QName PLINKROLE = new QName(
			NS_WSBPEL_PARTNERLINK_2004_03, "role");
	...
	// AH:
	private static QName newFinalFragmentQName(String localname) {
		return new QName(NS_WSBPEL2_0_FRAGMENT, localname);
	}
	// AH: end
}
