...
abstract class WSDLFactoryImpl extends WSDLFactory implements WSDLFactory4BPEL {
	...
	/**
	 * Create a {@link Definition4BPEL} object out of a standard WSDL
	 * {@link Definition}.
	 * 
	 * @param wsdlDef
	...
	public ExtensionRegistry newPopulatedExtensionRegistry() {
		ExtensionRegistry extRegistry = _wsdlFactory
				.newPopulatedExtensionRegistry();
		extRegistry.registerExtensionAttributeType(Operation.class, new QName(
				"http://www.w3.org/ns/wsdl-extensions", "safe"),
