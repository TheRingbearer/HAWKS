...
public class XMLSchemaTypeSerializer implements ExtensionSerializer,
	 ...
	 */
	public void marshall(Class clazz, QName qname,
			ExtensibilityElement element, PrintWriter writer,
	 ...
	 *      javax.wsdl.Definition, javax.wsdl.extensions.ExtensionRegistry)
	 */
	public ExtensibilityElement unmarshall(Class clazz, QName qname,
		...
		try {
			// xml dump is encoded in UTF-8, so the byte array should use the
			// same encoding
