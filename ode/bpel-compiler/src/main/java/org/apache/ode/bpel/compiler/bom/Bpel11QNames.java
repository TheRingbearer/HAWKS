...
public abstract class Bpel11QNames {
	...
	public static final QName PLINKTYPE = new QName(
			NS_BPEL4WS_PARTNERLINK_2003_05, "partnerLinkType");

	public static final QName PLINKROLE = new QName(
			NS_BPEL4WS_PARTNERLINK_2003_05, "role");

	public static final QName PORTTYPE = new QName(
			NS_BPEL4WS_PARTNERLINK_2003_05, "portType");
