 ...
 */
public class WSDLFactoryBPEL11 extends WSDLFactoryImpl implements
		WSDLFactory4BPEL {
	...
	public ExtensionRegistry newPopulatedExtensionRegistry() {
		...
		extRegistry.registerDeserializer(Definition.class, new QName(_bpwsNS,
				"property"), _bs);
		extRegistry.registerDeserializer(Definition.class, new QName(_bpwsNS,
				"propertyAlias"), _bs);
		extRegistry.registerDeserializer(Types.class, XMLSchemaType.QNAME,
				new XMLSchemaTypeSerializer());
		extRegistry.registerDeserializer(Definition.class,
				new QName(Bpel11QNames.NS_BPEL4WS_PARTNERLINK_2003_05,
						"partnerLinkType"), _bs);
