...
public class ForEachGeneratorMessages extends CompilationMessageBundle {
	...
	public CompilationMessage errForEachAndScopeVariableRedundant(
			String couterName) {
		return this
				.formatCompilationMessage("The <scope> activity nested inside forEach already declares a "
						+ "variable named {0}, just like the forEach counterName.");
	}

	public CompilationMessage errMissingScopeinForeach() {
		return this
				.formatCompilationMessage("<forEach> activity requires a child <scope>");
	}
