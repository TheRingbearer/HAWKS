 ...
 */
public class PropertyAlias extends BpelObject4WSDL implements
	...
	/**
	 * Get the name of the WSDL <code>message</code> type that this alias it to
	 * apply to.
	 * 
	...
	/**
	 * Get the name of the WSDL <code>part</code> that this alias is to apply to
	 * (within the specified <code>message</code>).
	 * 
