...
public class CommonCompilationMessages extends CompilationMessageBundle {
	...
	public CompilationMessage errUndeclaredLink(String linkName) {
		return this.formatCompilationMessage(
				"Attempt to reference undeclared link \"{0}\".", linkName);
	}

	/** The import "{0}" is invalid / malformed. */
	public CompilationMessage errInvalidImport(String importUri) {
		return this.formatCompilationMessage(
				"The import \"{0}\" is invalid/malformed. */", importUri);
	}

	/** Unable to import WSDL at URI "{0}"; WSDL fault code "{1}". */
	public CompilationMessage errWsdlImportFailed(String wsdlUri,
			String faultCode) {
		return this
	...
	public CompilationMessage errWsdlImportNotFound(String wsdlUri,
			String location) {
		return this
				.formatCompilationMessage(
						"The WSDL for namespace \"{0}\" could not be found in \"{1}\".",
	...
	/** {1}: [{0}] {2} */
	public CompilationMessage errWsdlParseError(String faultCode,
			String location, String message) {
		return this.formatCompilationMessage("{1}: [{0}] {2}", faultCode,
				location, message);
	}
	...
	public CompilationMessage errUnknownImportType(String importType) {
		return this.formatCompilationMessage(
				"The import type \"{0}\" is unknown.", importType);
	}
	...
	public CompilationMessage errUndeclaredVariable(String varName) {
		return this.formatCompilationMessage(
				"Attempt to reference undeclared variable \"{0}\".", varName);
	}
	...
	public CompilationMessage errDuplicateUseCorrelationSet(String csetName) {
		return this
				.formatCompilationMessage(
						"Attempt to use a correlation set \"{0}\" more than once for a set of correlations.",
						csetName);
	}

	/**
	 * Cannot use non-message variable "{0}" in this context (message variable
	 * is required).
	 */
	...
	public CompilationMessage errPropertyDeclaredWithComplexType(
			QName propertyName, QName complexType) {
		return this
				.formatCompilationMessage(
						"Attempt to declare property \"{0}\" with complex type \"{1}\".",
						propertyName, complexType);
	}

	/** Duplicate declaration of target for link "{0}". */
	public CompilationMessage errDuplicateLinkTarget(String linkName) {
		return this.formatCompilationMessage(
				"Duplicate declaration of target for link \"{0}\".", linkName);
	}

	/** Duplicate declaration of source for link "{0}". */
	public CompilationMessage errDuplicateLinkSource(String linkName) {
		return this.formatCompilationMessage(
				"Duplicate declaration of source for link \"{0}\".", linkName);
	}
		...
		return this
				.formatCompilationMessage(
						"Declaration of variable \"{0}\" does not specify"
								+ " the required type (either MessageType or ElementType).",
						varName);
	}

	public CompilationMessage errVariableDeclInvalid(String variable) {
		return this.formatCompilationMessage(
				"Declaration of variable \"{0}\" specifies "
	...
	public CompilationMessage errVariableDeclMutipleTypes(String varName) {
		return this
				.formatCompilationMessage(
						"Declaration of variable \"{0}\" can specify either"
								+ " MessageType or ElementType, but not both.",
						varName);
	}
	...
	public CompilationMessage errUnknownExpressionLanguage(
	...
	public CompilationMessage errNoWsdlDefinitionForNamespace(
			String namespaceURI) {
		return this.formatCompilationMessage(
				"No WSDL definition for namespace \"{0}\".", namespaceURI);
	}

	/** Attempt to reference undeclared WSDL message "{0}" in namespace {1}. */
	public CompilationMessage errUndeclaredMessage(String msgName,
			String namespaceURI) {
		return this.formatCompilationMessage(
				"Attempt to reference undeclared WSDL message \"{0}\""
						+ " in namespace {1}.", msgName, namespaceURI);
	}

	/** Missing message type reference in property alias {0} in namespace {1}. */
	public CompilationMessage errAliasUndeclaredMessage(QName property,
			String path) {
		return this
				.formatCompilationMessage(
	...
	public CompilationMessage errUndeclaredPropertyAlias(String messageType,
			QName propertyName) {
		return this.formatCompilationMessage(
				"The property \"{1}\" does not have an alias"
						+ " for message type \"{0}\".", messageType,
				propertyName);
	}
	...
	public CompilationMessage errUndeclaredRole(String roleName,
			QName partnerLinkTypeName) {
		return this
				.formatCompilationMessage(
						"Attempt to reference undeclared role \"{0}\" for partnerLink \"{1}\".",
						roleName, partnerLinkTypeName);
	}

	/** Attempt to reference undeclared portType "{0}". */
	public CompilationMessage errUndeclaredPortType(QName portType) {
		return this.formatCompilationMessage(
				"Attempt to reference undeclared portType \"{0}\".", portType);
	}
	 ...
	 */
	public CompilationMessage errUndeclaredMessagePart(String varName,
			QName messageType, String partName) {
		return this
				.formatCompilationMessage(
						"Attempt to reference undeclared part \"{2}\""
	...
	public CompilationMessage errPartnerLinkDoesNotDeclareMyRole(
	...
	public CompilationMessage errPartnerLinkDoesNotDeclarePartnerRole(
			String partnerLinkName) {
		return this.formatCompilationMessage(
				"The partnerLink \"{0}\" does not define a partnerRole.",
				partnerLinkName);
	...
	/**
	 * The partnerLink "{0}" does not define a partnerRole but is set to
	 * initializePartnerRole=yes.
	 */
	public CompilationMessage errPartnerLinkNoPartnerRoleButInitialize(
			String partnerLinkName) {
		return this
				.formatCompilationMessage(
	...
	public CompilationMessage errUndeclaredOperation(QName portType,
			String operationName) {
		return this.formatCompilationMessage(
				"The operation \"{1}\" is not declared on portType \"{0}\".",
				portType, operationName);
	}
	 ...
	 * actual type is "{1}".
	 */
	public CompilationMessage errVariableTypeMismatch(String varName,
			QName expectedType, QName actualType) {
		return this
				.formatCompilationMessage(
						"The variable \"{0}\" must be of type \"{1}\""
								+ " to be used in this context; its actual type is \"{2}\".",
						varName, expectedType, actualType);
	}

	/** The port type "{0}" does not match the expected port type ("{1}"). */
	public CompilationMessage errPortTypeMismatch(QName portType,
			QName expectedPortType) {
		return this.formatCompilationMessage(
				"The port type \"{0}\" does not match the expected"
						+ " port type (\"{1}\").", portType, expectedPortType);
	}

	/** Attempt to use correlation set "{0}" before it has been initialized. */
	public CompilationMessage errUseOfUninitializedCorrelationSet(
			String correlationSet) {
		return this.formatCompilationMessage(
				"Attempt to use correlation set \"{0}\" before"
	...
	public CompilationMessage errCompensateOfInvalidScope(
			String scopeToCompensate) {
		return this
				.formatCompilationMessage(
						"The scope \"{0}\" is not available for compensation in this context.",
						scopeToCompensate);
	...
	public CompilationMessage errUndeclaredXsdType(QName typeName) {
		return this.formatCompilationMessage(
				"Attempt to reference undeclared XSD type \"{0}\".", typeName);
	}
	...
	public CompilationMessage errDuplicateWSDLImport(String tns, String location) {
		return this
				.formatCompilationMessage(
						"Attempted to import WSDL for namespace {0} from"
								+ " multiple locations: definitions from {1} will be ignored!",
						tns, location);
	}
	...
	public CompilationMessage errSchemaError(String detailMessage) {
		return this.formatCompilationMessage("Error in schema processing: {0}",
				detailMessage);
	}
	...
	public CompilationMessage errInvalidDocXsltUri(String docStrUri) {
		return this.formatCompilationMessage(
				"XSLT stylesheet URI is invalid/malformed: {0}", docStrUri);
	}

	/**
	 * Could not find the XSLT stylesheet referenced with URI {0}, make sure it
	 * has been properly provided to the compiler.
	 */
	public CompilationMessage errCantFindXslt(String docStrUri) {
		return this
				.formatCompilationMessage(
						"Could not find the XSLT stylesheet referenced with URI {0}, make "
								+ "sure it has been properly provided to the compiler.",
						docStrUri);
	}
	...
	public CompilationMessage errInvalidDeploymentDescriptor(String message) {
		return this.formatCompilationMessage(
				"Deployment descriptor is invalid: {0}", message);
	}
	...
	public CompilationMessage errAtomicScopeNesting(boolean atomic) {
		if (atomic)
			return this
					.formatCompilationMessage("Cannot nest atomic scopes inside each other.");
		else
			return this
					.formatCompilationMessage("A scope enclosed inside an atomic scope cannot declare itself as not atomic");
	}

	public CompilationMessage errProcessNameNotSpecified() {
		return this
				.formatCompilationMessage("The process name was not specified.");
	}

	public CompilationMessage errProcessNamespaceNotSpecified() {
		return this
				.formatCompilationMessage("The process namespace was not specified.");
	}

	public CompilationMessage errMissingMyRolePortType(QName portType,
			String myRole, QName plnkType) {
		return formatCompilationMessage(
				"Missing portType {0} on partnerLinkType {1} for myRole {2}",
				portType, plnkType, myRole);
	}

	public CompilationMessage errMissingPartnerRolePortType(QName portType,
			String partnerRole, QName plnkType) {
		return formatCompilationMessage(
				"Missing portType {0} on partnerLinkType {1} for partnerRole {2}",
				portType, plnkType, partnerRole);
	}

	/**
	 * The part {0} declared in property alias for messageType {1} couldn't be
	 * found.
	 */
	public CompilationMessage errUnknownPartInAlias(String part, String message) {
		return this.formatCompilationMessage(
				"The part {0} declared in property alias for "
	...
	public CompilationMessage errEmptyCatch() {
		return this
				.formatCompilationMessage("Empty catch faut handlers are forbidden.");
	}

	public CompilationMessage errMustSpecifyRelatedVariable(String name) {
		return this
				.formatCompilationMessage(
						"The external variable declaration for \"{0}\" must specify a related variable.",
						name);
	}
	...
	public CompilationMessage errMustSpecifyExternalVariableId(String name) {
		return this
				.formatCompilationMessage(
						"The external variable declaration for \"{0}\" must specify an external variable identifier.",
						name);
	}
