...
/**
 * Extension of the WSDL {@link Definition} interface that includes manipulators
 * for BPEL-specific extensions.
 */
public interface Definition4BPEL extends Definition {
	 ...
	 * {@link org.apache.ode.bpel.compiler.bom.Property}s.
	 * 
	 * @return {@link List} of {@link org.apache.ode.bpel.compiler.bom.Property}
	 *         objects
	 */
	 ...
	 * 
	 * @return {@link List} of {@link org.apache.ode.utils.wsdl.XMLSchemaType}
	 *         objects
	 */
