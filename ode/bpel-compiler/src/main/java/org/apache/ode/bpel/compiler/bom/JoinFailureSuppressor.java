...
/**
 * Base class for nodes (such as {@link Activity} and {@link Process} that can
...
public class JoinFailureSuppressor extends BpelObject {
	...
	public SuppressJoinFailure getSuppressJoinFailure() {
		return getAttribute("suppressJoinFailure", __suppressJoinFailure,
				SuppressJoinFailure.NOTSET);
	}
