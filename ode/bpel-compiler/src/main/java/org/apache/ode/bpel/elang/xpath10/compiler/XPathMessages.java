...
public class XPathMessages extends CompilationMessageBundle {
	...
	public CompilationMessage errUnconfigurableXPathFactory() {
		return super
				.formatCompilationMessage("Couldn't configure XPath factory");
	}
	...
	public CompilationMessage errXslCompilation(String xslName, String error) {
		return super.formatCompilationMessage(
				"Error compiling XSL Sheet \"{0}\" : {1}", xslName, error);
	}
	...
	public CompilationMessage errLiteralExpected(String text) {
		return super.formatCompilationMessage(
				"The expression \"{0}\" must be a literal string.", text);
	}

	/** The prefix "{0}" on the XPath function "{1}" is not bound to a URI. */
	public CompilationMessage errUndeclaredFunctionPrefix(String prefix,
			String functionName) {
		return super.formatCompilationMessage(
				"The prefix \"{0}\" on the XPath function \"{1}\""
	...
	/** The string "{0}" is not a valid XPath 1.0 expression. */
	public CompilationMessage warnXPath20Syntax(String xPathString,
			String message) {
		return super.formatCompilationMessage(
	...
	public CompilationMessage errXQuery10Syntax(String xQueryString,
			String message) {
		return super.formatCompilationMessage(
				"The string \"{0}\" is not a valid XQuery 1.0 expression: {1}",
				xQueryString, message);
	}
	...
	public CompilationMessage errExpressionMessageNoPart(String message) {
		return super
				.formatCompilationMessage(
						"Attempt to use the messageType variable {0} in an expression "
								+ " even though the associated message is undefined or has no part.",
						message);
	}
	...
	public CompilationMessage errEmptyExpression(URI docUri, QName elementName) {
		return super
				.formatCompilationMessage(
						"XPath elementName and xpath node are both empty in file: {0}, element: {1}",
