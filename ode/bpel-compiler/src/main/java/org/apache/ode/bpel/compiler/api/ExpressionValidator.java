...
public interface ExpressionValidator {
	 ...
	 * 
	 * @param source
	 *            It's a Query or Expression
	 * @param requestedResultType
	 *            It's OVarType or underlying Expression Validator's type. It
	 *            may be null if there are no constrains for result type
	 * @return Evaluated expression's type
	 */
	Object validate(Expression source, OVarType rootNodeType,
