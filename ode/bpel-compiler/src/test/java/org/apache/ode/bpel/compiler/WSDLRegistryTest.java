...
public class WSDLRegistryTest extends TestCase {
	...
	public void testInitialModel() throws Exception {
		...
		// verify dummy model
		QName type = new QName("http://fivesight.com/bogus/namespace",
				"__bogusType__");
	...
	public void testAddWSDL() throws Exception {
		...
		// load & register wsdl
		WSDLFactory4BPEL factory = (WSDLFactory4BPEL) WSDLFactoryBPEL11
				.newInstance();
		WSDLReader reader = factory.newWSDLReader();

		// ResourceFinder finder = new DefaultResourceFinder(new
		// File(wsd.getPath()).getParentFile());
		...
		assertTrue("WSDL-Define type not visible.",
				m.knowsSchemaType(new QName("uri:testing", "TComplex1")));
		assertTrue("Type from import not visible.",
				m.knowsSchemaType(new QName("uri:test1", "TComplex2")));
