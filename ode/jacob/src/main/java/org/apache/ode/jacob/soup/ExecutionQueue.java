...
/**
 * The soup, the reactive "broth" that underlies the JACOB system. The
 * {@link ExecutionQueue} implementation is responsible for implementing the
 * JACOB reactive rules and maintaining the state of the reactive broth.
 * 
...
public interface ExecutionQueue {
	...
	/**
	 * Add a continuation to the broth. This operation is sometimes referred to
	 * as an "injection"; it can be used to inject into the broth the "original"
	 * continuation.
	 * 
	 * @param continuation
	 *            the {@link Continuation} to add to the broth
	 */
