...
public class Statistics {
	...
	/**
	 * Total time spent in each {@link org.apache.ode.jacob.JavaMethodBody}
	 * method.
	 */
	...
	public static final class PerTargetStatistics {
		...
		public String toString() {
			return "(n=" + invocations + ", total=" + totalRunTimeMs
					+ "ms, avg=" + getAvgRunTimePerInvocation() + "ms, min="
					+ minRunTimeMs + "ms, max=" + maxRunTimeMs + "ms)";
		}
	}
}
