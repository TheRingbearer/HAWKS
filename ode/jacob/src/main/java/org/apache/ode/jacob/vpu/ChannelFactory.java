...
public class ChannelFactory {
	...
	static {
		try {
			METHOD_OBJECT_EQUALS = Object.class.getMethod("equals",
	...
	public static Object getBackend(Channel channel) {
		ChannelInvocationHandler cih = (ChannelInvocationHandler) Proxy
				.getInvocationHandler(channel);
		return cih._backend;
	}
		...
		public Object invoke(Object proxy, Method method, Object[] args)
			...
			if (method.getDeclaringClass() == Object.class) {
				if (method.equals(METHOD_OBJECT_EQUALS)) {
					return Boolean.valueOf(this.equals(Proxy
							.getInvocationHandler(args[0])));
				}
				return method.invoke(this, args);
			}
			if (method.equals(METHOD_CHANNEL_EXPORT)) {
				return JacobVPU.activeJacobThread().exportChannel(
						(Channel) proxy);
			}
