...
public class JacobMessages extends MessageBundle {
	...
	/**
	 * Error indicating that a re-hydration of a saved _continuation object
	 ...
	 * @param mlClassName
	 *            name of de-hydrated
	 *            {@link org.apache.ode.jacob.ChannelListener} object
	 * 
	 */
	...
	/**
	 * Internal error indicating that a required client method was not
	 * accessible due to security protections errors. This may be caused by a
	 * change to the client class definitions.
	 * 
