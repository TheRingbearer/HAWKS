...
public class ProcessFilter extends Filter<ProcessFilter.FilterKeysOp> implements
	...
	/**
	 * List of additional information to include when producing the filter
	 * result, currently only 'properties' and 'instance' are supported.
	 */
	...
	/**
	 * Initializes properly the ProcessFilter attributes by pre-parsing the
	 * filter and orderKeys strings.
	 * 
	 * @param filter
	 * @param orderKeys
	 */
