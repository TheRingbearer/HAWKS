...
public class Messages extends MessageBundle {
	 ...
	 */
	public String msgUnrecognizedFilterKey(String filterKey,
			Collection<String> filterKeys) {
		return this.format(
				"The filter \"{0}\" is not recognized; try one of {1}.",
	...
	/**
	 * The restriction for filter "{0}" must follow the ISO-8601 date or
	 * date/time standard (yyyyMMddhhmmss); "{1}" does not follow this form.
	 */
