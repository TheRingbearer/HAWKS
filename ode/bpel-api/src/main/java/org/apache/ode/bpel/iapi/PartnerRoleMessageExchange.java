...
/**
 * A message exchange orginating from the BPEL server and targeting some
 * external partner.
 * 
...
public interface PartnerRoleMessageExchange extends MessageExchange {
	 ...
	 *             if delivering this type of message is inappropriate at the
	 *             present point.
	 */
	...
	/**
	 * Indicate that the response to the request/response operation is not yet
	 * available and that the response will be delivered asynchronously.
	 */
	void replyAsync();

	/**
	 * Get the {@link EndpointReference} associated with the my-role of the
	 * partner link to which this message exchange belongs. This method is
	 * typically used to provide protocol-specific "callback" mechanisms.
	 * 
	 * @return endpoint reference associate with the corresponding my-role, or
	 *         null if no my-role is defined
	 */
