...
/**
 * A representation of a communication (message-exchange) between the BPEL BPEL
 * engine and an external "partner".
 * 
 * @author mszefler
 */
public interface MessageExchange {
	...
	public enum MessageExchangePattern {
		REQUEST_ONLY, REQUEST_RESPONSE, UNKNOWN
	}
	...
	public enum Status {
		...
		// ONE_WAY, - supported as ASYNC + getMessageExchangePatter() - See JIRA
		// ODE-54
	...
	/**
	 * Get the operation description for this message exchange. It is possible
	 * that the description cannot be resolved, for example if the EPR is
	 * unknown or if the operation does not exist. TODO: How to get rid of the
	 * WSDL4j dependency?
	 * 
	...
	/**
	 * Get the port type description for this message exchange. It is possible
	 * that the description cannot be resolved, for example if the EPR is
	 * unknown or if the operation does not exist. TODO: How to get rid of the
	 * WSDL4j dependency?
	 * 
	 ...
	 * interpreted by the engine--they exist to enable the integration layer to
	 * persist information about the exchange.
	 * 
	 * @param key
	 *            property key
	 * @param value
	...
	/**
	 * Should be called by the external partner when it's done with the message
	 * exchange. Ncessary for a better resource management and proper mex
	 * cleanup.
	 */
	public void release();
