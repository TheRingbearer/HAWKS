...
public class ProcessState {
	...
	/**
	 * <em>READY</em> state: instance is waiting for a
	 * <code>&lt;receive&gt;</code> or <code>&lt;pick&gt;</code> with
	 * <code>createInstance="true"</code>.
	 */
	public static final short STATE_READY = 10;

	/**
	 * <em>ACTIVE</em> state: instance has received a
	 * <code>&lt;receive&gt;</code> or <code>&lt;pick&gt;</code> with
	 * <code>createInstance="true"</code>
	 */
	...
	/**
	 * <em>COMPLETED WITH FAULT</em> state: instance has reached the end of its
	 * execution due to an uncaught fault.
	 */
	 ...
	 */
	public static final short[] ALL_STATES = { STATE_NEW, STATE_READY,
			STATE_ACTIVE, STATE_COMPLETED_OK, STATE_COMPLETED_WITH_FAULT,
			STATE_SUSPENDED, STATE_TERMINATED };
	 ...
	 * not {@link #STATE_SUSPENDED} and not one of the completed or terminated
	 * states.
	 * 
	 * @param state
	...
	public static boolean canExecute(short state) {
		return state == STATE_READY || state == STATE_ACTIVE
				|| state == STATE_NEW;
	}
