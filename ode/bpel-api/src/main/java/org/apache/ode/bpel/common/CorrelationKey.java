 ...
 * messages with a particular process <em>instance</em>. The basic procedure is
 * to generate and save a correlation key when a <code>receive</code> or
 ...
 * 
 * <p>
 * The correlation keys used in the above process consists of a collection of
 * name-value pairs, with the name corresponding to a property name (as defined
 * using the <code>&lt;property&gt;</code> element of the BPEL process document)
 * and with the value corresponding to the value of said property as obtained
 * from a message by means of a property alias (as defined using the
 * <code>&lt;propertyAlias;&gt</code> BPEL process document element).
 * </p>
 */
public class CorrelationKey implements Serializable {
	...
	public CorrelationKey(String canonicalForm) {
		...
		_csetName = canonicalForm.substring(0,
	...
	public boolean equals(Object o) {
		...
		if (okey == null || !okey._csetName.equals(_csetName)
				|| okey._keyValues.length != _keyValues.length)
			return false;
