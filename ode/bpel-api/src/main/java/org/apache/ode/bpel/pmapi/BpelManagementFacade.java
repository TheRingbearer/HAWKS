...
/**
 * <p>
 * Instance management interaction interface. Instance management is a broad
 * concept that covers instance introspection, debugging, and monitoring. This
 * interface allows external systems to perform these functions.
 * </p>
 * 
 * <p>
 ...
 * </p>
 */
public interface BpelManagementFacade extends ProcessManagement,
		InstanceManagement {
	 ...
	 * @return process instance identifier of instance matching the given
	 *         correlationKey
	 */
	Long getProcessInstance(String pid, CorrelationKey ckey)
	 ...
	 */
	EventInfoListDocument getEvents(Long iid, int startIdx, int count)
			throws ManagementException;
	 ...
	 * Multiple scopes instances are only possible due to a BPEL 'while'
	 * activity.
	 * 
	 * */
	public Long[] getScopeInstancesForScope(Long iid, String scopeName)
			throws ManagementException;
	 ...
	 * @return
	 */
	String getVariable(Long iid, Long scopeId, String varName)
			throws ManagementException;
	 ...
	 * @param propertyNames
	 *            properties to set on correlation set
	 * @param values
	 *            property values as a CorrelationKey object
	 */
	void setCorrelation(Long iid, Long scopeId, String correlationSet,
			QName[] propertyNames, CorrelationKey values)
			throws ManagementException;
	 ...
	 * @return
	 */
	CorrelationKey getCorrelation(Long iid, Long scopeId, String correlationSet)
			throws ManagementException;
	 ...
	 * 
	 * @param iid
	 *            a iid of null removes a global breakpoint.
	 * @param sp
	 */
	 ...
	 * @param sp
	 */
	void removeGlobalBreakpoint(String procId, Breakpoint sp)
			throws ManagementException;
	 ...
	 * 
	 * @param iid
	 *            a iid of null adds a global activity breakpoint.
	 * @param activity
	 * @return
	 */
	ActivityBreakpoint addActivityBreakpoint(Long iid, String activity)
			throws ManagementException;
	 ...
	 * @return
	 */
	ActivityBreakpoint addGlobalActivityBreakpoint(String procId,
	 ...
	 * @return
	 */
	VariableModificationBreakpoint addVariableModificationBreakpoint(Long iid,
			String scopeName, String variable);
