...
public interface Scheduler {
	 ...
	 * @param when
	 *            when the job should run (<code>null</code> means now)
	 ...
	 * @throws ContextException
	 */
	String scheduleMapSerializableRunnable(MapSerializableRunnable runnable,
			Date when) throws ContextException;

	/**
	 * Schedule a volatile (non-persisted) job. Volatile jobs should not be
	 * saved in the database and should not survive system crash. Volatile jobs
	 * scheduled from a transactional context should be scheduled regardless of
	 * whether the transaction commits.
	 * 
	 * @param transacted
	 *            should the job be executed in a transaction?
	 * @param jobDetail
	 *            information about the job
	 * @param when
	 ...
	 */
	String scheduleVolatileJob(boolean transacted, JobDetails jobDetail,
			Date when) throws ContextException;
	 ...
	 *            the transaction service uses the default value.
	 * @return result
	 * @throws Exception
	 */
	...
	public interface Synchronizer {
		 ...
		 * 
		 * @param success
		 *            indicates whether the transaction was comitted
		 */
	...
	// ITERATE and Reexecute are added by Bo Ning
	// schlieta add finish
	// hahnml add jumpToActivity
	// AH: add INVOKE_FC
	public enum JobType {
		TIMER, RESUME, FINISH, INVOKE_INTERNAL, INVOKE_RESPONSE, MATCHER, INVOKE_CHECK, TIMER2, ITERATE, REEXECUTE, JUMPTOACTIVITY, INVOKE_FC
	}
	...
	public static class JobDetails implements Serializable {
		...
		public static final String SNAPSHOT_VERSION_KEY = "snapshotVersion";
		public static final String TARGET_ACTIVITY_XPATH = "targetXPath";
		public static final String SNAPSHOT_VARIABLES = "snapshotVariables";
		public static final String SNAPSHOT_PARTNERLINKS = "snapshotPartnerlinks";
		public static final String SNAPSHOT_XPATH = "snapshotXPath";
		public static final String EXT_MODE = "extMode";

		public JobDetails() {
			this.detailsExt.put("bool", false);
		}

		public void setBool(Boolean notFirstTime) {
			this.detailsExt.put("bool", notFirstTime);
		}

		public Boolean getBool() {
			return (Boolean) this.detailsExt.get("bool");
		}
		...
		public String toString() {
			return "JobDetails(" + " instanceId: " + instanceId + " mexId: "
					+ mexId + " processId: " + processId + " type: " + type
					+ " channel: " + channel + " correlatorId: " + correlatorId
					+ " correlationKeySet: " + correlationKeySet
					+ " retryCount: " + retryCount + " inMem: " + inMem
