...
public class ProcessInfoCustomizer {
	...
	public static final ProcessInfoCustomizer ALL = new ProcessInfoCustomizer(
			Item.ENDPOINTS, Item.PROPERTIES, Item.DOCUMENTS, Item.SUMMARY);
	public static final ProcessInfoCustomizer SUMMARYONLY = new ProcessInfoCustomizer(
			Item.SUMMARY);
	...
	public enum Item {
		SUMMARY, DOCUMENTS, PROPERTIES, ENDPOINTS
	}
