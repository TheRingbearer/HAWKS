...
/**
 * Deployed process configuration. IMPORTANT: Implementations of this class
 * <em>MUST BE IMMUTABLE</em>, otherwise the engine will get confused.
 * 
...
public interface ProcessConf {
	...
	public static class PartnerRoleConfig {
		...
		public PartnerRoleConfig(OFailureHandling failureHandling,
	...
	/**
	 * Is this a <em>transient</em> process? Transient processes are not
	...
	/**
	 * Get meta data for this process that uniquely identifies this process version.
	 * 
	 * @return meta data for this process
	 * 
	 * @author sonntamo
	 */
	...
	/**
	 * Gets the WSDL definition used in a process into which a service is
	 * defined.
	 * 
	 * @param processId
	 * @param serviceName
	...
	/**
	 * Gets the WSDL definition used in a process into which a PortType is
	 * defined.
	 * 
	 * @param portTypeName
	 * @return definition
	...
	// AH: used to generate versions for new fragment instances
	...
	public enum CLEANUP_CATEGORY {
		INSTANCE, VARIABLES, MESSAGES, CORRELATIONS, EVENTS;
	...
	public class CleanupInfo implements java.io.Serializable {
		...
		private final Set<CLEANUP_CATEGORY> _categories = EnumSet
				.noneOf(CLEANUP_CATEGORY.class);
