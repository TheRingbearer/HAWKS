...
public interface ProcessStore {
	...
	/**
	 * Gets all the details of a process configuration (properties, deploy
	 * dates, ...)
	 * 
	 * @param processId
