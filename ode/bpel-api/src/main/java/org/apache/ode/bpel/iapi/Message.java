...
public interface Message {
	...
	/**
	 * Set the message as an element. The name of the element is irrelevant, but
	 * it should have one child element for each message part. TODO: remove
	 * this, temporary hack.
	 */
	void setMessage(Element msg);

	/**
	 * Get the message as an element. The returned element will have one child
	 * element corresponding (and named after) each part in the message. TODO:
