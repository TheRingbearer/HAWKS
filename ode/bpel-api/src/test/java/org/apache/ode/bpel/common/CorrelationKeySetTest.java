...
public class CorrelationKeySetTest {
	...
	public void testRestoreFromCanonicalForm() throws Exception {
		...
		assertEquals(new CorrelationKeySet("-1~session_key"),
				new CorrelationKeySet().add(new CorrelationKey("-1",
		...
		assertEquals(new CorrelationKeySet("@2[1~key1~key2]"),
				new CorrelationKeySet().add(new CorrelationKey("1",
						new String[] { "key1", "key2" })));
		assertEquals(
				new CorrelationKeySet("@2[1~key1],[2~key2~key3]"),
				new CorrelationKeySet().add(
						new CorrelationKey("1", new String[] { "key1" }))
						.add(new CorrelationKey("2", new String[] { "key2",
								"key3" })));
		assertEquals(
				new CorrelationKeySet("@2[1~key1],[2~key2~key3]?"),
				new CorrelationKeySet().add(
						...
						.add(new CorrelationKey("2", new String[] { "key2",
								"key3" })));
		assertEquals(3, new CorrelationKeySet("@2[1~key1],[2~key2~key3]?")
				.findSubSets().size());
	}
	...
	public void testFindSubSets() throws Exception {
		...
		assertEquals(
				"'@2[1~a~b]','@2[2~b~c]','@2[1~a~b],[2~b~c]','@2[3~c~d]','@2[1~a~b],[3~c~d]','@2[2~b~c],[3~c~d]','@2[1~a~b],[2~b~c],[3~c~d]'",
				buf.toString());
