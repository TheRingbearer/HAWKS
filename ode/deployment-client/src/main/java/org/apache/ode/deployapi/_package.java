...
public class _package  implements java.io.Serializable {
    private org.apache.ode.xmlmime.Base64Binary zip;

    public _package() {
    }

    public _package(
           org.apache.ode.xmlmime.Base64Binary zip) {
           this.zip = zip;
    }
     ...
     * @return zip
     */
    public org.apache.ode.xmlmime.Base64Binary getZip() {
        return zip;
    }
     ...
     * @param zip
     */
    public void setZip(org.apache.ode.xmlmime.Base64Binary zip) {
        this.zip = zip;
    }
