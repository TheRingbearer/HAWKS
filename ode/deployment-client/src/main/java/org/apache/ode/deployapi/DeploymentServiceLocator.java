...
public class DeploymentServiceLocator extends org.apache.axis.client.Service implements org.apache.ode.deployapi.DeploymentService {
    ...
    public org.apache.ode.deployapi.DeploymentPortType getDeploymentPort() throws javax.xml.rpc.ServiceException {
    ...
    public org.apache.ode.deployapi.DeploymentPortType getDeploymentPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.apache.ode.deployapi.DeploymentBindingStub _stub = new org.apache.ode.deployapi.DeploymentBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.apache.ode.deployapi.DeploymentPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.apache.ode.deployapi.DeploymentBindingStub _stub = new org.apache.ode.deployapi.DeploymentBindingStub(new java.net.URL(DeploymentPort_address), this);
                _stub.setPortName(getDeploymentPortWSDDServiceName());
                return _stub;
            }
        }
