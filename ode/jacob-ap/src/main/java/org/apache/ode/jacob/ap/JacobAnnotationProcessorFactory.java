...
public class JacobAnnotationProcessorFactory implements
		AnnotationProcessorFactory {

	private static final List<String> __supported = Arrays
			.asList(new String[] { ChannelType.class.getName() });
	...
	public AnnotationProcessor getProcessorFor(
			Set<AnnotationTypeDeclaration> atd,
