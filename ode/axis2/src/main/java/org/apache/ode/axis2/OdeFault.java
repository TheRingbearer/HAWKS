...
public class OdeFault extends AxisFault {
	...
	public static final QName FAULT = new QName(
			"http://incubator.apache.org/ode", "Fault");
	...
	public OdeFault(String message, Throwable cause) {
		super(new QName("java:" + cause.getClass().getPackage(), cause
				.getClass().getName(), "java"), message, cause);
	}
