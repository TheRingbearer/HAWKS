...
public class URLEncodedTransformer {
	...
	private static final Log log = LogFactory
			.getLog(URLEncodedTransformer.class);
	...
	public String transform(Map<String, Element> values) {
		...
		for (Map.Entry<String, Element> e : values.entrySet()) {
			...
			if (DOMUtils.isEmptyElement(value)) {
				...
				/*
				 * The expected part value could be a simple type or an element
				 * of a simple type. So if a element is there, take its text
				 * content else take the text content of the part element itself
				 */
