...
/**
 * Client utilities that can be used to invoke easily the deployment and
 * management services with Axis2.
 */
public class ServiceClientUtil {
	 ...
	 * 
	 * @param msg
	 *            the message OMElement that will be included in the body
	 * @param url
	 *            to send the message to
	 * @return the response message
	 * @throws AxisFault
	 *             when a problem occured during the call
	 */
	 ...
	 *             when a problem occured during the call
	 */
	public OMElement send(OMElement msg, String url, long timeout)
			throws AxisFault {
	 ...
	 *            to call
	 * @param params
	 *            list of the parameters for the operation as defined in the
	 *            WSDL document
	 * @param values
	 *            of the parameters
	 * @return the message to send
	 */
	public OMElement buildMessage(String operation, String[] params,
			Object[] values) {
