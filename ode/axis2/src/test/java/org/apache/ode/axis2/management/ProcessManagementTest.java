...
/**
 * @deprecated Needs to be migrated in axis2-war and upgraded to the new
 *             Axis2TestBase test fwk.
 */
public class ProcessManagementTest extends TestCase {
	...
	public void testListProcesses() throws Exception {
		...
		listRoot = _client.buildMessage("listProcesses", new String[] {
				...
				"name=DynPartnerResponder namespace=http://ode/bpel/responder "
	...
	public void testProcessFiles() throws Exception {
		...
		Iterator docs = result
				.getFirstElement()
				.getFirstChildWithName(
						new QName(Namespaces.ODE_PMAPI_TYPES_NS, "documents"))
				.getChildElements();
		while (docs.hasNext()) {
			OMElement docElmt = (OMElement) docs.next();
			filenames
					.add(docElmt.getFirstChildWithName(
							new QName(Namespaces.ODE_PMAPI_TYPES_NS, "name"))
							.getText());
		}
	...
	public void testSetProcessProperty() throws Exception {
		OMElement root = _client
				.buildMessage("setProcessProperty", new String[] { "pid",
						"propertyName", "propertyValue" },
						new Object[] {
								new QName("http://ode/bpel/unit-test",
										"DynPartnerMain"),
	...
	public void testSetProcessPropertyNode() throws Exception {
		...
		OMElement root = _client
				.buildMessage("setProcessPropertyNode", new String[] { "pid",
						"propertyName", "propertyValue" },
						new Object[] {
								new QName("http://ode/bpel/unit-test",
										"DynPartnerMain"),
	...
	public void testGetExtensibilityElements() throws Exception {
		OMElement root = _client
				.buildMessage("getExtensibilityElements", new String[] { "pid",
						"aids" },
						new Object[] {
								new QName("http://ode/bpel/unit-test",
										"DynPartnerMain"),
	...
	protected void setUp() throws Exception {
		...
		OMElement root = _factory.createOMElement("deploy", pmapi); // qualified
		// operation
		// name
		...
		InputStream is = this.getClass().getClassLoader()
				.getResourceAsStream("DynPartner.zip");
