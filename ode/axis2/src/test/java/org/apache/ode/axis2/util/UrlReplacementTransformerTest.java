...
public class UrlReplacementTransformerTest extends TestCase {
	...
	public void testWithParentheses() {
		String[][] a = new String[][] {
				new String[] { "with alphabetical chars",
						"o1/A(part1)B(part2)/(part3)", "o1/AtutuBtiti/toto",
				...
				new String[] { "parts surrounded with ()",
						...
						"o1/A(3)B(14)/(159)", "part1", "3", "part2", "14",
						"part3", "159" },
				new String[] { "with numeric chars",
						"o1/A(part1)B(part2)/(part3)",
						"o1/A3B14/159%20and%20an%20epsilon", "part1", "3",
						"part2", "14", "part3", "159 and an epsilon" },
				new String[] { "with empty values",
						"o1/A(part1)B(part2)/(part3)", "o1/AB/", "part1", "",
						"part2", "", "part3", "" },
				new String[] {
						"with special chars",
						"o1/A(part1)B(part2)/(part3)",
						"o1/AWhatB%2410%2C000/~!%40%23%24%25%5E%26*()_%2B%3D-%60%5B%5D%7B%7D%7C%5C.",
						"part1", "What", "part2", "$10,000", "part3",
						"~!@#$%^&*()_+=-`[]{}|\\." },
				new String[] {
						...
						"part1",
						"value_of_part1_is_(part2)_and_should_not_be_replaced",
						"part2", "same_for_part2(part3)", "part3", "foo" } };
	...
	public void testComplexType() {
		...
		UrlReplacementTransformer encoder = new UrlReplacementTransformer();
		assertEquals(
				"Result should be equal to template because the only part is associated to a complex type",
				"(part1)", encoder.transform("(part1)", m));
