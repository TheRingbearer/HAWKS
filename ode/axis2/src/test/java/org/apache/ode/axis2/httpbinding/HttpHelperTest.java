...
public class HttpHelperTest extends TestCase {
	private static final String[] IS_XML = new String[] {
			...
			"text/xml; charset=ISO-8859-4", "application/xml",
	...
	private static final String[] IS_TEXT = new String[] {
			...
			"text/css; param1=value1; param2=value2", "text/csv" };
	private static final String[] IS_IMAGE = new String[] { "image/jpeg",
			"image/png", "image/gif; param1=value1; param2=value2" };
