...
public class ExecutionPathTest extends TestCase {
	...
	public void testListEvents() throws Exception {
		...
		assertTrue(result.toString().indexOf(
				"ID-5938e518-bfcf-1004-8cce-0438cf81d0f0") > 0);
	}
	...
	protected void setUp() throws Exception {
		...
		// Execute
		URL svcUrl = new URL(
				"http://localhost:8080/ode/processes/DynMainService");
		InputStream sis = getClass().getClassLoader().getResourceAsStream(
				"testDynPartnerRequest.soap");
