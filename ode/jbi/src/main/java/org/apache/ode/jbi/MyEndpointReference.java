...
class MyEndpointReference implements EndpointReference {
	...
	public boolean equals(Object obj) {
		if (obj instanceof MyEndpointReference)
			return _service
					...
					.getServiceName()
					.equals(((MyEndpointReference) obj)._service
							.getInternalServiceEndpoint().getServiceName());
		return false;
	}

	@Override
	public int hashCode() {
		return _service.getInternalServiceEndpoint().getServiceName()
				.hashCode();
	}
	...
	public Document toXML() {
		...
		Element root = xml.createElementNS(
