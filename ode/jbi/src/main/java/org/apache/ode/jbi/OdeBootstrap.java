 ...
 * interface. This is just a place-holder, nothing gets done in the bootstrap at
 * this point.
 */
public class OdeBootstrap implements Bootstrap {
	 ...
	 *            is the context containing information from the install command
	 *            and from the BPE jar file.
	 * 
	 * @throws javax.jbi.JBIException
