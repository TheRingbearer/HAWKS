 ...
 * conditions and delegates actual invocation to subclass.
 */
public abstract class BaseMessageExchangeProcessor implements
	...
	public void onJbiMessageExchange(MessageExchange jbiMex)
		...
		if (jbiMex.getPattern().equals(MessageExchangePattern.IN_ONLY)) {
			...
			LOG.error("JBI MessageExchange " + jbiMex.getExchangeId()
	 ...
	 */
	public abstract NormalizedMessage invoke(InOut mex)
			throws MessagingException;
