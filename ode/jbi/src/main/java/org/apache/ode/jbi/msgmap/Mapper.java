...
public interface Mapper {
	 ...
	 */
	void toNMS(NormalizedMessage nmsMsg, Message odeMsg,
	 ...
	 * @throws MessageTranslationException
	 */
	void toODE(Message odeMsg, NormalizedMessage nmsMsg,
	 ...
	 * @throws MessageTranslationException
	 */
	Fault toFaultType(javax.jbi.messaging.Fault jbiFlt, Collection<Fault> faults)
			throws MessageTranslationException;
