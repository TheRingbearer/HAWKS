...
public class Messages extends MessageBundle {
	...
	public String msgOdeInstallErrorCfgNotFound(File configFile) {
		return format("ODE-JBI config file {0} not found; using defaults!",
				configFile);
	}
	...
	public String msgServiceUnitShutdownFailed(String serviceUnitID) {
		return format("Error shutting down service unit \"{0}\".",
				serviceUnitID);
	}
	...
	public String msgOdeInitMapperClassLoadFailed(String messageMapper) {
		return format("Message mapper class \"{0}\" could not be loaded!",
				messageMapper);
	}

	public String msgOdeInitMapperInstantiationFailed(String messageMapper) {
		return format(
				"Message mapper class \"{0}\" could not be instantiated!",
				messageMapper);
	}

	public String msgOdeEmbeddedDbNotFoundUsingTemp(File dbDir, File tmpDir) {
		return format(
				"Embedded database directory \"{0}\" does not exist, creating temporary database in \"{1}\"!",
				dbDir, tmpDir);
	}
	...
	public String msgDAOInstantiationFailed(String className) {
		return format(
				"Failed to instantiate DAO Connection Factory class {0}.",
				className);
	}
