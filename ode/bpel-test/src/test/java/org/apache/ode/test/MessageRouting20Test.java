...
public class MessageRouting20Test extends BPELTestAbstract {
	...
	@Test
	public void testCorrelationJoin() throws Throwable {
		go("/bpel/2.0/TestCorrelationJoin");
	}

	@Test
	public void testCorrelationJoinReceive() throws Throwable {
		go("/bpel/2.0/TestCorrelationJoinReceive");
	}

	@Test
	public void testCorrelationJoinInvoke() throws Throwable {
		go("/bpel/2.0/TestCorrelationJoinInvoke");
	}

	@Test
	public void testCorrelationJoinOnMessage() throws Throwable {
		go("/bpel/2.0/TestCorrelationJoinOnMessage");
	}

	@Test
	public void testCorrelationJoinEvent() throws Throwable {
		go("/bpel/2.0/TestCorrelationJoinEvent");
	}

	@Test
	public void testCorrelationJoinReply() throws Throwable {
		go("/bpel/2.0/TestCorrelationJoinReply");
	}

	@Test
	public void testCorrelationMulti() throws Throwable {
		go("/bpel/2.0/TestCorrelationMulti");
	}

	@Test
	public void testCorrelationMultiNegative() throws Throwable {
		go("/bpel/2.0/TestCorrelationMultiNegative");
	}

	@Test
	public void testCorrelationMultiJoin() throws Throwable {
		go("/bpel/2.0/TestCorrelationMultiJoin");
	}

	@Test
	public void testCorrelationMultiComplex() throws Throwable {
	...
	public void testCorrelationOpaque() throws Throwable {
		// TODO Fix me, we need to capture the session id to send it in the
		// second test message
	...
	public void testNegativeCorrelation() throws Throwable {
		/**
		 * This test contains invalid BPEL. There is an instantiating <receive>
		 * and a subsequent <pick> that does not define a correlation key. The
		 * BPEL compiler should throw an exception indicating the BPEL code
		 * error ( verify with spec ).
		 * 
		 * See JIRA ODE-64
		 * 
		 */
	...
	public void testNegativeInitialization() throws Throwable {
		/**
		 * This test contains invalid BPEL. There is an instantiating <receive>
		 * within a <scope>. The <scope> contains eventhandlers that reference
		 * the correlation set found on the receive. The BPEL compiler should
		 * throw an exception indicating the BPEL error ( verify with spec ) or
		 * at runtime a clear initialization exception should be thrown.
		 * 
		 * See JIRA ODE-61.
		 * 
	...
	@Test
	public void testConcurrentSyncMex() throws Throwable {
		go("/bpel/2.0/TestConcurrentSyncMex");
	}

	@Test
	public void testIMA() throws Throwable {
		go("/bpel/2.0/TestIMA");
	}
}
