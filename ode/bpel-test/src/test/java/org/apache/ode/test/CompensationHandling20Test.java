...
public class CompensationHandling20Test extends BPELTestAbstract {
	...
	public void testImplicitFaultHandler() throws Throwable {
		 ...
		 * 
		 * @ab6dcb timed out when waiting for a response!
		 ...
		 * 
		 * at
		 * org.apache.ode.test.BPELTestAbstract.checkFailure(BPELTestAbstract.
		 * java:278) at
		 * org.apache.ode.test.BPELTestAbstract.go(BPELTestAbstract.java:267) at
		 * org
		 * .apache.ode.test.CompensationHandling20Test.testImplicitFaultHandler
		 * (CompensationHandling20Test.java:45)
		 */
		deploy("/bpel/2.0/TestImplicitFaultHandler");
		Invocation inv = addInvoke(
				"Invoke#1",
				new QName(
						"http://ode/bpel/unit-test/testImplicitFaultHandler.wsdl",
						"testImplicitFaultHandlerService"),
				"request",
		...
		inv.expectedResponsePattern = Pattern
				.compile(".*Event TestFaultWithVariable1 -&gt; caught FaultMessage1 -&gt; Event TestFaultWithVariable1 -&gt; process complete.*");
