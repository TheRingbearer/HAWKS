...
public class BasicActivities20Test extends BPELTestAbstract {
	...
	public void testNegativeTargetNS1() throws Throwable {
		 ...
		 * See JIRA ODE-67 Test for a specific exception message.
		 */
	...
	@Test
	public void testIfBoolean() throws Throwable {
	...
	public void testWaitFor() throws Throwable {
		...
		Invocation inv = addInvoke("Wait1#1", new QName(
				"http://ode/bpel/unit-test.wsdl", "testService"),
				"testOperation", "<message><TestPart/><Time/></message>", null);
	...
	public void testWaitUntil() throws Throwable {
		...
		String isountil = idf
				.format(new Date(System.currentTimeMillis() + 5000));
		Invocation inv = addInvoke("WaitUntil", new QName(
				"http://ode/bpel/unit-test.wsdl", "testService"),
				"testOperation", "<message><TestPart/><Time>" + isountil
						+ "</Time></message>", null);
	 ...
	 */
	@Test
	public void testWaitUntilPast() throws Throwable {
		deploy("/bpel/2.0/TestWaitUntil");
		DateFormat idf = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS");
		String isountil = idf
				.format(new Date(System.currentTimeMillis() - 5000));
	 ...
	 */
	@Test
	public void testOnAlarm() throws Throwable {
		deploy("/bpel/2.0/TestAlarm");
		Invocation inv = addInvoke(
				"Wait1#1",
				new QName("http://ode.apache.org/example",
