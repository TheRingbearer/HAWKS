...
public class SerializerTest {
	...
	public void testOnMessageBackwardCompatibility() throws Exception {
		...
		cset1.name = "cset1";
		Field matchCorrelationField = OPickReceive.OnMessage.class
				.getDeclaredField("matchCorrelation");
		...
		Field joinCorrelationsField = OPickReceive.OnMessage.class
				.getDeclaredField("joinCorrelations");
		...
		cset2.name = "cset2";
		Field joinCorrelationField = OPickReceive.OnMessage.class
				.getDeclaredField("joinCorrelation");
		...
		try {
			...
			assertEquals(
					"The value in 'matchCorrelation' member should've been transferred to 'matchCorrelations'",
					"cset1", onMessage.matchCorrelations.get(0).name);
			assertNotNull("'joinCorrelations' member cannot be null",
					onMessage.joinCorrelations);
			assertEquals(
					"The value in 'joinCorrelation' member should've been transferred to 'joinCorrelations'",
	...
	public void testOEventBackwardCompatibility() throws Exception {
		...
		OScope.CorrelationSet cset1 = new OScope.CorrelationSet(null);
		cset1.name = "cset1";
		Field matchCorrelationField = OEventHandler.OEvent.class
				.getDeclaredField("matchCorrelation");
		matchCorrelationField.setAccessible(true);
		matchCorrelationField.set(oEvent, cset1);

		Field joinCorrelationsField = OEventHandler.OEvent.class
				.getDeclaredField("joinCorrelations");
		joinCorrelationsField.setAccessible(true);
		...
		OScope.CorrelationSet cset2 = new OScope.CorrelationSet(null);
		cset2.name = "cset2";
		Field joinCorrelationField = OEventHandler.OEvent.class
				.getDeclaredField("joinCorrelation");
		joinCorrelationField.setAccessible(true);
	...
	public void testOReplyBackwardCompatibility() throws Exception {
		...
		Field joinCorrelationsField = OReply.class
				.getDeclaredField("joinCorrelations");
		joinCorrelationsField.setAccessible(true);
	...
	public void testOInvokeBackwardCompatibility() throws Exception {
		...
		Field joinCorrelationsField = OInvoke.class
				.getDeclaredField("joinCorrelationsInput");
		joinCorrelationsField.setAccessible(true);
		joinCorrelationsField.set(invoke, null);
		joinCorrelationsField = OInvoke.class
				.getDeclaredField("joinCorrelationsOutput");
		joinCorrelationsField.setAccessible(true);
		joinCorrelationsField.set(invoke, null);
		...
		try {
			...
			assertNotNull("'joinCorrelationsInput' member cannot be null",
					invoke.joinCorrelationsInput);
			assertNotNull("'joinCorrelationsOutput' member cannot be null",
