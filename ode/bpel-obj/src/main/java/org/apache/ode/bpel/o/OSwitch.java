...
/**
 * Compiled representation of a BPEL <code>&lt;switch&gt;</code>. The BPEL
 * compiler generates instances of this class.
 */
public class OSwitch extends OActivity {
	...
	// @hahnml:
	public OSwitch(OProcess owner, OActivity parent, int id) {
	...
	public static class OCase extends OBase {
		...
		// @hahnml:
		public OCase(OProcess owner, int id) {
			super(owner, id);
		}
	}
}
