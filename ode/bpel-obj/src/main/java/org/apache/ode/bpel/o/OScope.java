...
/**
 * Compiled representation of a BPEL scope. Instances of this class are
 * generated by the BPEL compiler.
 */
public class OScope extends OActivity {
	...
	/**
	 * The descendants of this scope that can be compensated from the FH/CH of
	 * this scope.
	 */
	...
	// @hahnml:
	public OScope(OProcess owner, OActivity parent, int id) {
	...
	public static final class CorrelationSet extends OBase {
		...
		// @hahnml:
		public CorrelationSet(OProcess owner, int id) {
			super(owner, id);
		}
	...
	public static final class Variable extends OBase {
		...
		/**
		 * If not-null indicates that this variable has an external
		 * representation.
		 */
		...
		// @hahnml:
		public Variable(OProcess owner, OVarType type, int id) {
			super(owner, id);
			this.type = type;
		}
