...
public class OInvoke extends OActivity {
	...
	// @hahnml:
	public OInvoke(OProcess owner, OActivity parent, int id) {
	...
	private void readObject(ObjectInputStream in) throws IOException,
		...
		// backward compatibility; joinCorrelationInput could be null if read
		// from old definition
		if (joinCorrelationsInput == null) {
			try {
				Field field = OInvoke.class
		...
		// backward compatibility; joinCorrelationOutput could be null if read
		// from old definition
