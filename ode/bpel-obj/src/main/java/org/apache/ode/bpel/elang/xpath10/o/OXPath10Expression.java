...
public class OXPath10Expression extends OLValueExpression implements
	...
	public HashMap<String, OScope.Variable> vars = new HashMap<String, OScope.Variable>();

	public final HashMap<String, OProcess.OProperty> properties = new HashMap<String, OProcess.OProperty>();
	...
	private final HashMap<SigGetVariableData, OSigGetVariableData> _getVariableDataSigs = new HashMap<SigGetVariableData, OSigGetVariableData>();
	...
	// @hahnml
	public OXPath10Expression(OProcess owner, QName qname_getVariableData,
			QName qname_getVariableProperty, QName qname_getLinkStatus, int id) {
		super(owner, id);
		this.qname_getLinkStatus = qname_getLinkStatus;
		this.qname_getVariableData = qname_getVariableData;
		this.qname_getVariableProperty = qname_getVariableProperty;
	 ...
	 * <code>bpws:getVariableData(...)</code> call.
	 * 
	 * @param varname
	 *            variable name
	 * @param partname
	...
	public void addGetVariableDataSig(String varname, String partname,
		...
		_getVariableDataSigs.put(new SigGetVariableData(varname, partname,
				location), compiled);
	}
	 ...
	 * <code>bpws:getVariableData</code> invocation.
	 */
	private static final class SigGetVariableData implements Serializable {
		...
		public boolean equals(Object obj) {
			...
			if (varname != null
					&& (other.varname == null || !varname.equals(other.varname)))
				return false;
			if (partname != null
					&& (other.partname == null || !partname
							.equals(other.partname)))
				return false;
			if (location != null
					&& (other.location == null || !location
	...
	public static final class OSigGetVariableData extends OBase {
		...
		// @hahnml:
		public OSigGetVariableData(OProcess owner, OScope.Variable variable,
				OMessageVarType.Part part, OExpression location, int id) {
			super(owner, id);
			this.variable = variable;
			this.part = part;
			this.location = location;
