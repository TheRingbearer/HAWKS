...
/**
 * Base class for compiled expressions. The exact form of a compiled expression
 * is dependent on the compiler implementation.
 */
public abstract class OExpression extends OBase {
	...
	// @hahnml:
	public OExpression(OProcess owner, int id) {
		super(owner, id);
	}
