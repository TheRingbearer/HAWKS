...
public class OEventHandler extends OAgent {
	...
	// @hahnml:
	public OEventHandler(OProcess owner, int id) {
		super(owner, id);
	}
	...
	public static class OAlarm extends OAgent {
		...
		// @hahnml:
		public OAlarm(OProcess owner, int id) {
			super(owner, id);
		}
	}
	...
	public static class OEvent extends OScope {
		...
		// @hahnml:
		public OEvent(OProcess owner, OActivity parent, int id) {
