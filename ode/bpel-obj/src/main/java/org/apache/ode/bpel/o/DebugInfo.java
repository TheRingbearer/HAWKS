...
public class DebugInfo implements Serializable {
	...
	/**
	 * Do not load the description and extensibilityElements fields, as they may
	 * be big and are not really required at run-time.
	 * 
	 * @param ois
	 * @throws IOException
	...
	private void readObject(ObjectInputStream ois) throws IOException,
		...
		extensibilityElements = (HashMap<QName, Object>) getField.get(
				"extensibilityElements", null);
	}
