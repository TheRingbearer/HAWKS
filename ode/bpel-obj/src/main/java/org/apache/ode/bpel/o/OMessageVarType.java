...
public class OMessageVarType extends OVarType {
	...
	public static class Part extends OBase {
		...
		// @hahnml:
		public Part(OProcess owner, String partName, OVarType partType, int id) {
			super(owner, id);
			this.name = partName;
			this.type = partType;
		}
	...
	// AH: need for property aleases
	public boolean equals(Object o) {
		boolean result = false;
		if (o != null && o instanceof OMessageVarType) {
			OMessageVarType type = (OMessageVarType) o;
			if (docLitType != null) {
				return docLitType.equals(type.docLitType);
			} else {
				result = type.messageType.equals(messageType);
			}
		}
